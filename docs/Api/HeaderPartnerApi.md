# BeLenka\SAP\SalesOrder\HeaderPartnerApi
...
```php
aSalesOrderHeaderPartnerGet($top, $skip, $filter, $inlinecount, $orderby, $select, $expand): \BeLenka\SAP\SalesOrder\Model\Wrapper2
```
