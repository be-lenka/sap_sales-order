...
/**
 * APISALESORDERSRVASlsOrdPaymentPlanItemDetailsTypeCreate Class Doc Comment
 *
 * @category Class
 * @package  BeLenka\SAP\SalesOrder
 * @author   OpenAPI Generator team
 ...
 */
class APISALESORDERSRVASlsOrdPaymentPlanItemDetailsTypeCreate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'API_SALES_ORDER_SRV.A_SlsOrdPaymentPlanItemDetailsType-create';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['payment_plan_item'] === null) {
            $invalidProperties[] = "'payment_plan_item' can't be null";
        }
        if ((mb_strlen($this->container['payment_plan_item']) > 6)) {
     ...
     *
     * @param string $payment_plan_item Item for billing plan/invoice plan/payment cards
     *
     * @return self
     */
    public function setPaymentPlanItem($payment_plan_item)
    {
        ...
        if ((mb_strlen($payment_plan_item) > 6)) {
            throw new \InvalidArgumentException('invalid length for $payment_plan_item when calling APISALESORDERSRVASlsOrdPaymentPlanItemDetailsTypeCreate., must be smaller than or equal to 6.');
        }
    ...
    public function setElectronicPaymentType($electronic_payment_type)
    {
        ...
        if (!is_null($electronic_payment_type) && (mb_strlen($electronic_payment_type) > 4)) {
            throw new \InvalidArgumentException('invalid length for $electronic_payment_type when calling APISALESORDERSRVASlsOrdPaymentPlanItemDetailsTypeCreate., must be smaller than or equal to 4.');
        }
    ...
    public function setElectronicPayment($electronic_payment)
    {
        ...
        if (!is_null($electronic_payment) && (mb_strlen($electronic_payment) > 25)) {
            throw new \InvalidArgumentException('invalid length for $electronic_payment when calling APISALESORDERSRVASlsOrdPaymentPlanItemDetailsTypeCreate., must be smaller than or equal to 25.');
        }
    ...
    public function setElectronicPaymentHolderName($electronic_payment_holder_name)
    {
        ...
        if (!is_null($electronic_payment_holder_name) && (mb_strlen($electronic_payment_holder_name) > 40)) {
            throw new \InvalidArgumentException('invalid length for $electronic_payment_holder_name when calling APISALESORDERSRVASlsOrdPaymentPlanItemDetailsTypeCreate., must be smaller than or equal to 40.');
        }
    ...
    public function setAuthorizationByDigitalPaytSrvc($authorization_by_digital_payt_srvc)
    {
        ...
        if (!is_null($authorization_by_digital_payt_srvc) && (mb_strlen($authorization_by_digital_payt_srvc) > 10)) {
            throw new \InvalidArgumentException('invalid length for $authorization_by_digital_payt_srvc when calling APISALESORDERSRVASlsOrdPaymentPlanItemDetailsTypeCreate., must be smaller than or equal to 10.');
        }
    ...
    public function setEPaytByDigitalPaymentSrvc($e_payt_by_digital_payment_srvc)
    {
        ...
        if (!is_null($e_payt_by_digital_payment_srvc) && (mb_strlen($e_payt_by_digital_payment_srvc) > 25)) {
            throw new \InvalidArgumentException('invalid length for $e_payt_by_digital_payment_srvc when calling APISALESORDERSRVASlsOrdPaymentPlanItemDetailsTypeCreate., must be smaller than or equal to 25.');
        }
    ...
    public function setPaymentServiceProvider($payment_service_provider)
    {
        ...
        if (!is_null($payment_service_provider) && (mb_strlen($payment_service_provider) > 4)) {
            throw new \InvalidArgumentException('invalid length for $payment_service_provider when calling APISALESORDERSRVASlsOrdPaymentPlanItemDetailsTypeCreate., must be smaller than or equal to 4.');
        }
    ...
    public function setPaymentByPaymentServicePrvdr($payment_by_payment_service_prvdr)
    {
        ...
        if (!is_null($payment_by_payment_service_prvdr) && (mb_strlen($payment_by_payment_service_prvdr) > 40)) {
            throw new \InvalidArgumentException('invalid length for $payment_by_payment_service_prvdr when calling APISALESORDERSRVASlsOrdPaymentPlanItemDetailsTypeCreate., must be smaller than or equal to 40.');
        }
    ...
    public function setTransactionByPaytSrvcPrvdr($transaction_by_payt_srvc_prvdr)
    {
        ...
        if (!is_null($transaction_by_payt_srvc_prvdr) && (mb_strlen($transaction_by_payt_srvc_prvdr) > 40)) {
            throw new \InvalidArgumentException('invalid length for $transaction_by_payt_srvc_prvdr when calling APISALESORDERSRVASlsOrdPaymentPlanItemDetailsTypeCreate., must be smaller than or equal to 40.');
        }
    ...
    public function setMerchantByClearingHouse($merchant_by_clearing_house)
    {
        ...
        if (!is_null($merchant_by_clearing_house) && (mb_strlen($merchant_by_clearing_house) > 15)) {
            throw new \InvalidArgumentException('invalid length for $merchant_by_clearing_house when calling APISALESORDERSRVASlsOrdPaymentPlanItemDetailsTypeCreate., must be smaller than or equal to 15.');
        }
    ...
    public function setPaymentCardAuthznRelationId($payment_card_authzn_relation_id)
    {
        ...
        if (!is_null($payment_card_authzn_relation_id) && (mb_strlen($payment_card_authzn_relation_id) > 44)) {
            throw new \InvalidArgumentException('invalid length for $payment_card_authzn_relation_id when calling APISALESORDERSRVASlsOrdPaymentPlanItemDetailsTypeCreate., must be smaller than or equal to 44.');
        }
