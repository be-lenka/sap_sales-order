<?php
/**
 * APISALESORDERSRVASalesOrderItemRelatedObjectType
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * APISALESORDERSRVASalesOrderItemRelatedObjectType Class Doc Comment
 *
 * @category Class
 * @package  BeLenka\SAP\SalesOrder
 * @author   OpenAPI Generator team
 ...
 */
class APISALESORDERSRVASalesOrderItemRelatedObjectType implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'API_SALES_ORDER_SRV.A_SalesOrderItemRelatedObjectType';
    ...
    */
    ...
    public function setSalesOrder($sales_order)
    {
        ...
        if ((mb_strlen($sales_order) > 10)) {
            throw new \InvalidArgumentException('invalid length for $sales_order when calling APISALESORDERSRVASalesOrderItemRelatedObjectType., must be smaller than or equal to 10.');
        }
    ...
    public function setSalesOrderItem($sales_order_item)
    {
        ...
        if ((mb_strlen($sales_order_item) > 6)) {
            throw new \InvalidArgumentException('invalid length for $sales_order_item when calling APISALESORDERSRVASalesOrderItemRelatedObjectType., must be smaller than or equal to 6.');
        }
    ...
    public function setSdDocRelatedObjectSequenceNmbr($sd_doc_related_object_sequence_nmbr)
    {
        ...
        if ((mb_strlen($sd_doc_related_object_sequence_nmbr) > 4)) {
            throw new \InvalidArgumentException('invalid length for $sd_doc_related_object_sequence_nmbr when calling APISALESORDERSRVASalesOrderItemRelatedObjectType., must be smaller than or equal to 4.');
        }
    ...
    public function setSdDocumentRelatedObjectType($sd_document_related_object_type)
    {
        ...
        if (!is_null($sd_document_related_object_type) && (mb_strlen($sd_document_related_object_type) > 5)) {
            throw new \InvalidArgumentException('invalid length for $sd_document_related_object_type when calling APISALESORDERSRVASalesOrderItemRelatedObjectType., must be smaller than or equal to 5.');
        }
    ...
    public function setSdDocRelatedObjectSystem($sd_doc_related_object_system)
    {
        ...
        if (!is_null($sd_doc_related_object_system) && (mb_strlen($sd_doc_related_object_system) > 60)) {
            throw new \InvalidArgumentException('invalid length for $sd_doc_related_object_system when calling APISALESORDERSRVASalesOrderItemRelatedObjectType., must be smaller than or equal to 60.');
        }
    ...
    public function setSdDocRelatedObjectReference1($sd_doc_related_object_reference1)
    {
        ...
        if (!is_null($sd_doc_related_object_reference1) && (mb_strlen($sd_doc_related_object_reference1) > 60)) {
            throw new \InvalidArgumentException('invalid length for $sd_doc_related_object_reference1 when calling APISALESORDERSRVASalesOrderItemRelatedObjectType., must be smaller than or equal to 60.');
        }
    ...
    public function setSdDocRelatedObjectReference2($sd_doc_related_object_reference2)
    {
        ...
        if (!is_null($sd_doc_related_object_reference2) && (mb_strlen($sd_doc_related_object_reference2) > 60)) {
            throw new \InvalidArgumentException('invalid length for $sd_doc_related_object_reference2 when calling APISALESORDERSRVASalesOrderItemRelatedObjectType., must be smaller than or equal to 60.');
        }
