...
/**
 * APISALESORDERSRVASalesOrderItemTextTypeCreate Class Doc Comment
 *
 * @category Class
 * @package  BeLenka\SAP\SalesOrder
 * @author   OpenAPI Generator team
 ...
 */
class APISALESORDERSRVASalesOrderItemTextTypeCreate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'API_SALES_ORDER_SRV.A_SalesOrderItemTextType-create';
    ...
    */
    ...
    public function setLanguage($language)
    {
        ...
        if ((mb_strlen($language) > 2)) {
            throw new \InvalidArgumentException('invalid length for $language when calling APISALESORDERSRVASalesOrderItemTextTypeCreate., must be smaller than or equal to 2.');
        }
    ...
    public function setLongTextId($long_text_id)
    {
        ...
        if ((mb_strlen($long_text_id) > 4)) {
            throw new \InvalidArgumentException('invalid length for $long_text_id when calling APISALESORDERSRVASalesOrderItemTextTypeCreate., must be smaller than or equal to 4.');
        }
