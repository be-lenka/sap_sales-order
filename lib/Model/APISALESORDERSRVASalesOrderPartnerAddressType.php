<?php
/**
 * APISALESORDERSRVASalesOrderPartnerAddressType
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * APISALESORDERSRVASalesOrderPartnerAddressType Class Doc Comment
 *
 * @category Class
 * @package  BeLenka\SAP\SalesOrder
 * @author   OpenAPI Generator team
 ...
 */
class APISALESORDERSRVASalesOrderPartnerAddressType implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'API_SALES_ORDER_SRV.A_SalesOrderPartnerAddressType';
    ...
    protected static $openAPITypes = [
        ...
        'to_partner' => '\BeLenka\SAP\SalesOrder\Model\APISALESORDERSRVASalesOrderHeaderPartnerType',
    ...
    */
    ...
    public function setSalesOrder($sales_order)
    {
        ...
        if ((mb_strlen($sales_order) > 10)) {
            throw new \InvalidArgumentException('invalid length for $sales_order when calling APISALESORDERSRVASalesOrderPartnerAddressType., must be smaller than or equal to 10.');
        }
    ...
    public function setPartnerFunction($partner_function)
    {
        ...
        if ((mb_strlen($partner_function) > 2)) {
            throw new \InvalidArgumentException('invalid length for $partner_function when calling APISALESORDERSRVASalesOrderPartnerAddressType., must be smaller than or equal to 2.');
        }
    ...
    public function setAddressRepresentationCode($address_representation_code)
    {
        ...
        if ((mb_strlen($address_representation_code) > 1)) {
            throw new \InvalidArgumentException('invalid length for $address_representation_code when calling APISALESORDERSRVASalesOrderPartnerAddressType., must be smaller than or equal to 1.');
        }
    ...
    public function setCorrespondenceLanguage($correspondence_language)
    {
        ...
        if (!is_null($correspondence_language) && (mb_strlen($correspondence_language) > 2)) {
            throw new \InvalidArgumentException('invalid length for $correspondence_language when calling APISALESORDERSRVASalesOrderPartnerAddressType., must be smaller than or equal to 2.');
        }
    ...
    public function setAddresseeFullName($addressee_full_name)
    {
        ...
        if (!is_null($addressee_full_name) && (mb_strlen($addressee_full_name) > 80)) {
            throw new \InvalidArgumentException('invalid length for $addressee_full_name when calling APISALESORDERSRVASalesOrderPartnerAddressType., must be smaller than or equal to 80.');
        }
    ...
    public function setOrganizationName1($organization_name1)
    {
        ...
        if (!is_null($organization_name1) && (mb_strlen($organization_name1) > 40)) {
            throw new \InvalidArgumentException('invalid length for $organization_name1 when calling APISALESORDERSRVASalesOrderPartnerAddressType., must be smaller than or equal to 40.');
        }
    ...
    public function setOrganizationName2($organization_name2)
    {
        ...
        if (!is_null($organization_name2) && (mb_strlen($organization_name2) > 40)) {
            throw new \InvalidArgumentException('invalid length for $organization_name2 when calling APISALESORDERSRVASalesOrderPartnerAddressType., must be smaller than or equal to 40.');
        }
    ...
    public function setOrganizationName3($organization_name3)
    {
        ...
        if (!is_null($organization_name3) && (mb_strlen($organization_name3) > 40)) {
            throw new \InvalidArgumentException('invalid length for $organization_name3 when calling APISALESORDERSRVASalesOrderPartnerAddressType., must be smaller than or equal to 40.');
        }
    ...
    public function setOrganizationName4($organization_name4)
    {
        ...
        if (!is_null($organization_name4) && (mb_strlen($organization_name4) > 40)) {
            throw new \InvalidArgumentException('invalid length for $organization_name4 when calling APISALESORDERSRVASalesOrderPartnerAddressType., must be smaller than or equal to 40.');
        }
    ...
    public function setCityName($city_name)
    {
        ...
        if (!is_null($city_name) && (mb_strlen($city_name) > 40)) {
            throw new \InvalidArgumentException('invalid length for $city_name when calling APISALESORDERSRVASalesOrderPartnerAddressType., must be smaller than or equal to 40.');
        }
    ...
    public function setDistrictName($district_name)
    {
        ...
        if (!is_null($district_name) && (mb_strlen($district_name) > 40)) {
            throw new \InvalidArgumentException('invalid length for $district_name when calling APISALESORDERSRVASalesOrderPartnerAddressType., must be smaller than or equal to 40.');
        }
    ...
    public function setPostalCode($postal_code)
    {
        ...
        if (!is_null($postal_code) && (mb_strlen($postal_code) > 10)) {
            throw new \InvalidArgumentException('invalid length for $postal_code when calling APISALESORDERSRVASalesOrderPartnerAddressType., must be smaller than or equal to 10.');
        }
    ...
    public function setStreetPrefixName1($street_prefix_name1)
    {
        ...
        if (!is_null($street_prefix_name1) && (mb_strlen($street_prefix_name1) > 40)) {
            throw new \InvalidArgumentException('invalid length for $street_prefix_name1 when calling APISALESORDERSRVASalesOrderPartnerAddressType., must be smaller than or equal to 40.');
        }
    ...
    public function setStreetPrefixName2($street_prefix_name2)
    {
        ...
        if (!is_null($street_prefix_name2) && (mb_strlen($street_prefix_name2) > 40)) {
            throw new \InvalidArgumentException('invalid length for $street_prefix_name2 when calling APISALESORDERSRVASalesOrderPartnerAddressType., must be smaller than or equal to 40.');
        }
    ...
    public function setStreetName($street_name)
    {
        ...
        if (!is_null($street_name) && (mb_strlen($street_name) > 60)) {
            throw new \InvalidArgumentException('invalid length for $street_name when calling APISALESORDERSRVASalesOrderPartnerAddressType., must be smaller than or equal to 60.');
        }
    ...
    public function setStreetSuffixName1($street_suffix_name1)
    {
        ...
        if (!is_null($street_suffix_name1) && (mb_strlen($street_suffix_name1) > 40)) {
            throw new \InvalidArgumentException('invalid length for $street_suffix_name1 when calling APISALESORDERSRVASalesOrderPartnerAddressType., must be smaller than or equal to 40.');
        }
    ...
    public function setStreetSuffixName2($street_suffix_name2)
    {
        ...
        if (!is_null($street_suffix_name2) && (mb_strlen($street_suffix_name2) > 40)) {
            throw new \InvalidArgumentException('invalid length for $street_suffix_name2 when calling APISALESORDERSRVASalesOrderPartnerAddressType., must be smaller than or equal to 40.');
        }
    ...
    public function setHouseNumber($house_number)
    {
        ...
        if (!is_null($house_number) && (mb_strlen($house_number) > 10)) {
            throw new \InvalidArgumentException('invalid length for $house_number when calling APISALESORDERSRVASalesOrderPartnerAddressType., must be smaller than or equal to 10.');
        }
    ...
    public function setCountry($country)
    {
        ...
        if (!is_null($country) && (mb_strlen($country) > 3)) {
            throw new \InvalidArgumentException('invalid length for $country when calling APISALESORDERSRVASalesOrderPartnerAddressType., must be smaller than or equal to 3.');
        }
    ...
    public function setRegion($region)
    {
        ...
        if (!is_null($region) && (mb_strlen($region) > 3)) {
            throw new \InvalidArgumentException('invalid length for $region when calling APISALESORDERSRVASalesOrderPartnerAddressType., must be smaller than or equal to 3.');
        }
    ...
    public function setFormOfAddress($form_of_address)
    {
        ...
        if (!is_null($form_of_address) && (mb_strlen($form_of_address) > 4)) {
            throw new \InvalidArgumentException('invalid length for $form_of_address when calling APISALESORDERSRVASalesOrderPartnerAddressType., must be smaller than or equal to 4.');
        }
    ...
    public function setTaxJurisdiction($tax_jurisdiction)
    {
        ...
        if (!is_null($tax_jurisdiction) && (mb_strlen($tax_jurisdiction) > 15)) {
            throw new \InvalidArgumentException('invalid length for $tax_jurisdiction when calling APISALESORDERSRVASalesOrderPartnerAddressType., must be smaller than or equal to 15.');
        }
    ...
    public function setTransportZone($transport_zone)
    {
        ...
        if (!is_null($transport_zone) && (mb_strlen($transport_zone) > 10)) {
            throw new \InvalidArgumentException('invalid length for $transport_zone when calling APISALESORDERSRVASalesOrderPartnerAddressType., must be smaller than or equal to 10.');
        }
    ...
    public function setPoBox($po_box)
    {
        ...
        if (!is_null($po_box) && (mb_strlen($po_box) > 10)) {
            throw new \InvalidArgumentException('invalid length for $po_box when calling APISALESORDERSRVASalesOrderPartnerAddressType., must be smaller than or equal to 10.');
        }
    ...
    public function setPoBoxPostalCode($po_box_postal_code)
    {
        ...
        if (!is_null($po_box_postal_code) && (mb_strlen($po_box_postal_code) > 10)) {
            throw new \InvalidArgumentException('invalid length for $po_box_postal_code when calling APISALESORDERSRVASalesOrderPartnerAddressType., must be smaller than or equal to 10.');
        }
    ...
    public function setEmailAddress($email_address)
    {
        ...
        if (!is_null($email_address) && (mb_strlen($email_address) > 241)) {
            throw new \InvalidArgumentException('invalid length for $email_address when calling APISALESORDERSRVASalesOrderPartnerAddressType., must be smaller than or equal to 241.');
        }
    ...
    public function setMobilePhoneCountry($mobile_phone_country)
    {
        ...
        if (!is_null($mobile_phone_country) && (mb_strlen($mobile_phone_country) > 3)) {
            throw new \InvalidArgumentException('invalid length for $mobile_phone_country when calling APISALESORDERSRVASalesOrderPartnerAddressType., must be smaller than or equal to 3.');
        }
    ...
    public function setMobileNumber($mobile_number)
    {
        ...
        if (!is_null($mobile_number) && (mb_strlen($mobile_number) > 30)) {
            throw new \InvalidArgumentException('invalid length for $mobile_number when calling APISALESORDERSRVASalesOrderPartnerAddressType., must be smaller than or equal to 30.');
        }
    ...
    public function setPhoneNumberCountry($phone_number_country)
    {
        ...
        if (!is_null($phone_number_country) && (mb_strlen($phone_number_country) > 3)) {
            throw new \InvalidArgumentException('invalid length for $phone_number_country when calling APISALESORDERSRVASalesOrderPartnerAddressType., must be smaller than or equal to 3.');
        }
    ...
    public function setPhoneNumber($phone_number)
    {
        ...
        if (!is_null($phone_number) && (mb_strlen($phone_number) > 30)) {
            throw new \InvalidArgumentException('invalid length for $phone_number when calling APISALESORDERSRVASalesOrderPartnerAddressType., must be smaller than or equal to 30.');
        }
    ...
    public function setPhoneExtensionNumber($phone_extension_number)
    {
        ...
        if (!is_null($phone_extension_number) && (mb_strlen($phone_extension_number) > 10)) {
            throw new \InvalidArgumentException('invalid length for $phone_extension_number when calling APISALESORDERSRVASalesOrderPartnerAddressType., must be smaller than or equal to 10.');
        }
    ...
    public function setFaxNumberCountry($fax_number_country)
    {
        ...
        if (!is_null($fax_number_country) && (mb_strlen($fax_number_country) > 3)) {
            throw new \InvalidArgumentException('invalid length for $fax_number_country when calling APISALESORDERSRVASalesOrderPartnerAddressType., must be smaller than or equal to 3.');
        }
    ...
    public function setFaxAreaCodeSubscriberNumber($fax_area_code_subscriber_number)
    {
        ...
        if (!is_null($fax_area_code_subscriber_number) && (mb_strlen($fax_area_code_subscriber_number) > 30)) {
            throw new \InvalidArgumentException('invalid length for $fax_area_code_subscriber_number when calling APISALESORDERSRVASalesOrderPartnerAddressType., must be smaller than or equal to 30.');
        }
    ...
    public function setFaxExtensionNumber($fax_extension_number)
    {
        ...
        if (!is_null($fax_extension_number) && (mb_strlen($fax_extension_number) > 10)) {
            throw new \InvalidArgumentException('invalid length for $fax_extension_number when calling APISALESORDERSRVASalesOrderPartnerAddressType., must be smaller than or equal to 10.');
        }
     ...
     * Gets to_partner
     *
     * @return \BeLenka\SAP\SalesOrder\Model\APISALESORDERSRVASalesOrderHeaderPartnerType|null
     */
     ...
     * Sets to_partner
     *
     * @param \BeLenka\SAP\SalesOrder\Model\APISALESORDERSRVASalesOrderHeaderPartnerType|null $to_partner to_partner
     *
     * @return self
     */
