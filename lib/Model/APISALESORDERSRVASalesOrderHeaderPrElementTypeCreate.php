...
/**
 * APISALESORDERSRVASalesOrderHeaderPrElementTypeCreate Class Doc Comment
 *
 * @category Class
 * @package  BeLenka\SAP\SalesOrder
 * @author   OpenAPI Generator team
 ...
 */
class APISALESORDERSRVASalesOrderHeaderPrElementTypeCreate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'API_SALES_ORDER_SRV.A_SalesOrderHeaderPrElementType-create';
    ...
    */
    ...
    public function setPricingProcedureStep($pricing_procedure_step)
    {
        ...
        if ((mb_strlen($pricing_procedure_step) > 3)) {
            throw new \InvalidArgumentException('invalid length for $pricing_procedure_step when calling APISALESORDERSRVASalesOrderHeaderPrElementTypeCreate., must be smaller than or equal to 3.');
        }
    ...
    public function setPricingProcedureCounter($pricing_procedure_counter)
    {
        ...
        if ((mb_strlen($pricing_procedure_counter) > 3)) {
            throw new \InvalidArgumentException('invalid length for $pricing_procedure_counter when calling APISALESORDERSRVASalesOrderHeaderPrElementTypeCreate., must be smaller than or equal to 3.');
        }
    ...
    public function setConditionType($condition_type)
    {
        ...
        if (!is_null($condition_type) && (mb_strlen($condition_type) > 4)) {
            throw new \InvalidArgumentException('invalid length for $condition_type when calling APISALESORDERSRVASalesOrderHeaderPrElementTypeCreate., must be smaller than or equal to 4.');
        }
    ...
    public function setConditionCurrency($condition_currency)
    {
        ...
        if (!is_null($condition_currency) && (mb_strlen($condition_currency) > 5)) {
            throw new \InvalidArgumentException('invalid length for $condition_currency when calling APISALESORDERSRVASalesOrderHeaderPrElementTypeCreate., must be smaller than or equal to 5.');
        }
    ...
    public function setConditionQuantityUnit($condition_quantity_unit)
    {
        ...
        if (!is_null($condition_quantity_unit) && (mb_strlen($condition_quantity_unit) > 3)) {
            throw new \InvalidArgumentException('invalid length for $condition_quantity_unit when calling APISALESORDERSRVASalesOrderHeaderPrElementTypeCreate., must be smaller than or equal to 3.');
        }
    ...
    public function setConditionQuantitySapUnit($condition_quantity_sap_unit)
    {
        ...
        if (!is_null($condition_quantity_sap_unit) && (mb_strlen($condition_quantity_sap_unit) > 3)) {
            throw new \InvalidArgumentException('invalid length for $condition_quantity_sap_unit when calling APISALESORDERSRVASalesOrderHeaderPrElementTypeCreate., must be smaller than or equal to 3.');
        }
    ...
    public function setConditionQuantityIsoUnit($condition_quantity_iso_unit)
    {
        ...
        if (!is_null($condition_quantity_iso_unit) && (mb_strlen($condition_quantity_iso_unit) > 3)) {
            throw new \InvalidArgumentException('invalid length for $condition_quantity_iso_unit when calling APISALESORDERSRVASalesOrderHeaderPrElementTypeCreate., must be smaller than or equal to 3.');
        }
    ...
    public function setTransactionCurrency($transaction_currency)
    {
        ...
        if (!is_null($transaction_currency) && (mb_strlen($transaction_currency) > 5)) {
            throw new \InvalidArgumentException('invalid length for $transaction_currency when calling APISALESORDERSRVASalesOrderHeaderPrElementTypeCreate., must be smaller than or equal to 5.');
        }
