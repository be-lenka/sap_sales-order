...
/**
 * APISALESORDERSRVASalesOrderBillingPlanType Class Doc Comment
 *
 * @category Class
 * @package  BeLenka\SAP\SalesOrder
 * @author   OpenAPI Generator team
 ...
 */
class APISALESORDERSRVASalesOrderBillingPlanType implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'API_SALES_ORDER_SRV.A_SalesOrderBillingPlanType';
    ...
    protected static $openAPITypes = [
        ...
        'to_billing_plan_item' => '\BeLenka\SAP\SalesOrder\Model\APISALESORDERSRVASalesOrderBillingPlanTypeToBillingPlanItem',
    ...
    */
    ...
    public function setSalesOrder($sales_order)
    {
        ...
        if ((mb_strlen($sales_order) > 10)) {
            throw new \InvalidArgumentException('invalid length for $sales_order when calling APISALESORDERSRVASalesOrderBillingPlanType., must be smaller than or equal to 10.');
        }
    ...
    public function setBillingPlan($billing_plan)
    {
        ...
        if ((mb_strlen($billing_plan) > 10)) {
            throw new \InvalidArgumentException('invalid length for $billing_plan when calling APISALESORDERSRVASalesOrderBillingPlanType., must be smaller than or equal to 10.');
        }
    ...
    public function setBillingPlanStartDateRule($billing_plan_start_date_rule)
    {
        ...
        if (!is_null($billing_plan_start_date_rule) && (mb_strlen($billing_plan_start_date_rule) > 2)) {
            throw new \InvalidArgumentException('invalid length for $billing_plan_start_date_rule when calling APISALESORDERSRVASalesOrderBillingPlanType., must be smaller than or equal to 2.');
        }
    ...
    public function setReferenceBillingPlan($reference_billing_plan)
    {
        ...
        if (!is_null($reference_billing_plan) && (mb_strlen($reference_billing_plan) > 10)) {
            throw new \InvalidArgumentException('invalid length for $reference_billing_plan when calling APISALESORDERSRVASalesOrderBillingPlanType., must be smaller than or equal to 10.');
        }
    ...
    public function setBillingPlanCategory($billing_plan_category)
    {
        ...
        if (!is_null($billing_plan_category) && (mb_strlen($billing_plan_category) > 1)) {
            throw new \InvalidArgumentException('invalid length for $billing_plan_category when calling APISALESORDERSRVASalesOrderBillingPlanType., must be smaller than or equal to 1.');
        }
    ...
    public function setBillingPlanType($billing_plan_type)
    {
        ...
        if (!is_null($billing_plan_type) && (mb_strlen($billing_plan_type) > 2)) {
            throw new \InvalidArgumentException('invalid length for $billing_plan_type when calling APISALESORDERSRVASalesOrderBillingPlanType., must be smaller than or equal to 2.');
        }
    ...
    public function setBillingPlanEndDateRule($billing_plan_end_date_rule)
    {
        ...
        if (!is_null($billing_plan_end_date_rule) && (mb_strlen($billing_plan_end_date_rule) > 2)) {
            throw new \InvalidArgumentException('invalid length for $billing_plan_end_date_rule when calling APISALESORDERSRVASalesOrderBillingPlanType., must be smaller than or equal to 2.');
        }
    ...
    public function setBillingPlanSearchTerm($billing_plan_search_term)
    {
        ...
        if (!is_null($billing_plan_search_term) && (mb_strlen($billing_plan_search_term) > 10)) {
            throw new \InvalidArgumentException('invalid length for $billing_plan_search_term when calling APISALESORDERSRVASalesOrderBillingPlanType., must be smaller than or equal to 10.');
        }
     ...
     *
     * @return \BeLenka\SAP\SalesOrder\Model\APISALESORDERSRVASalesOrderBillingPlanTypeToBillingPlanItem|null
     */
     ...
     *
     * @param \BeLenka\SAP\SalesOrder\Model\APISALESORDERSRVASalesOrderBillingPlanTypeToBillingPlanItem|null $to_billing_plan_item to_billing_plan_item
     *
     * @return self
     */
