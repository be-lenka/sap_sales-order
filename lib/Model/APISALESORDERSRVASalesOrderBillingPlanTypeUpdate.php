...
/**
 * APISALESORDERSRVASalesOrderBillingPlanTypeUpdate Class Doc Comment
 *
 * @category Class
 * @package  BeLenka\SAP\SalesOrder
 * @author   OpenAPI Generator team
 ...
 */
class APISALESORDERSRVASalesOrderBillingPlanTypeUpdate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'API_SALES_ORDER_SRV.A_SalesOrderBillingPlanType-update';
    ...
    */
    ...
    public function setBillingPlanStartDateRule($billing_plan_start_date_rule)
    {
        ...
        if (!is_null($billing_plan_start_date_rule) && (mb_strlen($billing_plan_start_date_rule) > 2)) {
            throw new \InvalidArgumentException('invalid length for $billing_plan_start_date_rule when calling APISALESORDERSRVASalesOrderBillingPlanTypeUpdate., must be smaller than or equal to 2.');
        }
    ...
    public function setReferenceBillingPlan($reference_billing_plan)
    {
        ...
        if (!is_null($reference_billing_plan) && (mb_strlen($reference_billing_plan) > 10)) {
            throw new \InvalidArgumentException('invalid length for $reference_billing_plan when calling APISALESORDERSRVASalesOrderBillingPlanTypeUpdate., must be smaller than or equal to 10.');
        }
