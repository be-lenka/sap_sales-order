<?php
/**
 * APISALESORDERSRVASalesOrderSubsqntProcFlowTypeCreate
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * APISALESORDERSRVASalesOrderSubsqntProcFlowTypeCreate Class Doc Comment
 *
 * @category Class
 * @package  BeLenka\SAP\SalesOrder
 * @author   OpenAPI Generator team
 ...
 */
class APISALESORDERSRVASalesOrderSubsqntProcFlowTypeCreate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'API_SALES_ORDER_SRV.A_SalesOrderSubsqntProcFlowType-create';
    ...
    */
    ...
    public function setSalesOrder($sales_order)
    {
        ...
        if ((mb_strlen($sales_order) > 10)) {
            throw new \InvalidArgumentException('invalid length for $sales_order when calling APISALESORDERSRVASalesOrderSubsqntProcFlowTypeCreate., must be smaller than or equal to 10.');
        }
    ...
    public function setSubsequentDocument($subsequent_document)
    {
        ...
        if (!is_null($subsequent_document) && (mb_strlen($subsequent_document) > 10)) {
            throw new \InvalidArgumentException('invalid length for $subsequent_document when calling APISALESORDERSRVASalesOrderSubsqntProcFlowTypeCreate., must be smaller than or equal to 10.');
        }
    ...
    public function setSubsequentDocumentCategory($subsequent_document_category)
    {
        ...
        if (!is_null($subsequent_document_category) && (mb_strlen($subsequent_document_category) > 4)) {
            throw new \InvalidArgumentException('invalid length for $subsequent_document_category when calling APISALESORDERSRVASalesOrderSubsqntProcFlowTypeCreate., must be smaller than or equal to 4.');
        }
    ...
    public function setProcessFlowLevel($process_flow_level)
    {
        ...
        if (!is_null($process_flow_level) && (mb_strlen($process_flow_level) > 2)) {
            throw new \InvalidArgumentException('invalid length for $process_flow_level when calling APISALESORDERSRVASalesOrderSubsqntProcFlowTypeCreate., must be smaller than or equal to 2.');
        }
    ...
    public function setOverallSdProcessStatus($overall_sd_process_status)
    {
        ...
        if (!is_null($overall_sd_process_status) && (mb_strlen($overall_sd_process_status) > 1)) {
            throw new \InvalidArgumentException('invalid length for $overall_sd_process_status when calling APISALESORDERSRVASalesOrderSubsqntProcFlowTypeCreate., must be smaller than or equal to 1.');
        }
