<?php
/**
 * APISALESORDERSRVASalesOrderPrecdgProcFlowType
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * APISALESORDERSRVASalesOrderPrecdgProcFlowType Class Doc Comment
 *
 * @category Class
 * @package  BeLenka\SAP\SalesOrder
 * @author   OpenAPI Generator team
 ...
 */
class APISALESORDERSRVASalesOrderPrecdgProcFlowType implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'API_SALES_ORDER_SRV.A_SalesOrderPrecdgProcFlowType';
    ...
    */
    ...
    public function setSalesOrder($sales_order)
    {
        ...
        if ((mb_strlen($sales_order) > 10)) {
            throw new \InvalidArgumentException('invalid length for $sales_order when calling APISALESORDERSRVASalesOrderPrecdgProcFlowType., must be smaller than or equal to 10.');
        }
    ...
    public function setPrecedingDocument($preceding_document)
    {
        ...
        if (!is_null($preceding_document) && (mb_strlen($preceding_document) > 10)) {
            throw new \InvalidArgumentException('invalid length for $preceding_document when calling APISALESORDERSRVASalesOrderPrecdgProcFlowType., must be smaller than or equal to 10.');
        }
    ...
    public function setPrecedingDocumentCategory($preceding_document_category)
    {
        ...
        if (!is_null($preceding_document_category) && (mb_strlen($preceding_document_category) > 4)) {
            throw new \InvalidArgumentException('invalid length for $preceding_document_category when calling APISALESORDERSRVASalesOrderPrecdgProcFlowType., must be smaller than or equal to 4.');
        }
    ...
    public function setProcessFlowLevel($process_flow_level)
    {
        ...
        if (!is_null($process_flow_level) && (mb_strlen($process_flow_level) > 2)) {
            throw new \InvalidArgumentException('invalid length for $process_flow_level when calling APISALESORDERSRVASalesOrderPrecdgProcFlowType., must be smaller than or equal to 2.');
        }
    ...
    public function setOverallSdProcessStatus($overall_sd_process_status)
    {
        ...
        if (!is_null($overall_sd_process_status) && (mb_strlen($overall_sd_process_status) > 1)) {
            throw new \InvalidArgumentException('invalid length for $overall_sd_process_status when calling APISALESORDERSRVASalesOrderPrecdgProcFlowType., must be smaller than or equal to 1.');
        }
