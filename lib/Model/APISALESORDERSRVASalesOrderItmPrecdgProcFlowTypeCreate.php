...
/**
 * APISALESORDERSRVASalesOrderItmPrecdgProcFlowTypeCreate Class Doc Comment
 *
 * @category Class
 * @package  BeLenka\SAP\SalesOrder
 * @author   OpenAPI Generator team
 ...
 */
class APISALESORDERSRVASalesOrderItmPrecdgProcFlowTypeCreate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'API_SALES_ORDER_SRV.A_SalesOrderItmPrecdgProcFlowType-create';
    ...
    */
     ...
     * Sets sales_order
     *
     * @param string $sales_order Subsequent Sales and Distribution Document
     *
     * @return self
     */
    public function setSalesOrder($sales_order)
    {
        ...
        if ((mb_strlen($sales_order) > 10)) {
            throw new \InvalidArgumentException('invalid length for $sales_order when calling APISALESORDERSRVASalesOrderItmPrecdgProcFlowTypeCreate., must be smaller than or equal to 10.');
        }
     ...
     *
     * @param string $sales_order_item Subsequent Item of an SD Document
     *
     * @return self
     */
    public function setSalesOrderItem($sales_order_item)
    {
        ...
        if ((mb_strlen($sales_order_item) > 6)) {
            throw new \InvalidArgumentException('invalid length for $sales_order_item when calling APISALESORDERSRVASalesOrderItmPrecdgProcFlowTypeCreate., must be smaller than or equal to 6.');
        }
    ...
    public function setPrecedingDocument($preceding_document)
    {
        ...
        if (!is_null($preceding_document) && (mb_strlen($preceding_document) > 10)) {
            throw new \InvalidArgumentException('invalid length for $preceding_document when calling APISALESORDERSRVASalesOrderItmPrecdgProcFlowTypeCreate., must be smaller than or equal to 10.');
        }
    ...
    public function setPrecedingDocumentItem($preceding_document_item)
    {
        ...
        if (!is_null($preceding_document_item) && (mb_strlen($preceding_document_item) > 6)) {
            throw new \InvalidArgumentException('invalid length for $preceding_document_item when calling APISALESORDERSRVASalesOrderItmPrecdgProcFlowTypeCreate., must be smaller than or equal to 6.');
        }
    ...
    public function setPrecedingDocumentCategory($preceding_document_category)
    {
        ...
        if (!is_null($preceding_document_category) && (mb_strlen($preceding_document_category) > 4)) {
            throw new \InvalidArgumentException('invalid length for $preceding_document_category when calling APISALESORDERSRVASalesOrderItmPrecdgProcFlowTypeCreate., must be smaller than or equal to 4.');
        }
    ...
    public function setProcessFlowLevel($process_flow_level)
    {
        ...
        if (!is_null($process_flow_level) && (mb_strlen($process_flow_level) > 2)) {
            throw new \InvalidArgumentException('invalid length for $process_flow_level when calling APISALESORDERSRVASalesOrderItmPrecdgProcFlowTypeCreate., must be smaller than or equal to 2.');
        }
    ...
    public function setRelatedProcFlowDocStsFieldName($related_proc_flow_doc_sts_field_name)
    {
        ...
        if (!is_null($related_proc_flow_doc_sts_field_name) && (mb_strlen($related_proc_flow_doc_sts_field_name) > 30)) {
            throw new \InvalidArgumentException('invalid length for $related_proc_flow_doc_sts_field_name when calling APISALESORDERSRVASalesOrderItmPrecdgProcFlowTypeCreate., must be smaller than or equal to 30.');
        }
    ...
    public function setSdProcessStatus($sd_process_status)
    {
        ...
        if (!is_null($sd_process_status) && (mb_strlen($sd_process_status) > 1)) {
            throw new \InvalidArgumentException('invalid length for $sd_process_status when calling APISALESORDERSRVASalesOrderItmPrecdgProcFlowTypeCreate., must be smaller than or equal to 1.');
        }
    ...
    public function setAccountingTransferStatus($accounting_transfer_status)
    {
        ...
        if (!is_null($accounting_transfer_status) && (mb_strlen($accounting_transfer_status) > 1)) {
            throw new \InvalidArgumentException('invalid length for $accounting_transfer_status when calling APISALESORDERSRVASalesOrderItmPrecdgProcFlowTypeCreate., must be smaller than or equal to 1.');
        }
    ...
    public function setPrelimBillingDocumentStatus($prelim_billing_document_status)
    {
        ...
        if (!is_null($prelim_billing_document_status) && (mb_strlen($prelim_billing_document_status) > 1)) {
            throw new \InvalidArgumentException('invalid length for $prelim_billing_document_status when calling APISALESORDERSRVASalesOrderItmPrecdgProcFlowTypeCreate., must be smaller than or equal to 1.');
        }
