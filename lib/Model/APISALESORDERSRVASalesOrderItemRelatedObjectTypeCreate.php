...
/**
 * APISALESORDERSRVASalesOrderItemRelatedObjectTypeCreate Class Doc Comment
 *
 * @category Class
 * @package  BeLenka\SAP\SalesOrder
 * @author   OpenAPI Generator team
 ...
 */
class APISALESORDERSRVASalesOrderItemRelatedObjectTypeCreate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'API_SALES_ORDER_SRV.A_SalesOrderItemRelatedObjectType-create';
    ...
    */
    ...
    public function setSdDocumentRelatedObjectType($sd_document_related_object_type)
    {
        ...
        if (!is_null($sd_document_related_object_type) && (mb_strlen($sd_document_related_object_type) > 5)) {
            throw new \InvalidArgumentException('invalid length for $sd_document_related_object_type when calling APISALESORDERSRVASalesOrderItemRelatedObjectTypeCreate., must be smaller than or equal to 5.');
        }
    ...
    public function setSdDocRelatedObjectSystem($sd_doc_related_object_system)
    {
        ...
        if (!is_null($sd_doc_related_object_system) && (mb_strlen($sd_doc_related_object_system) > 60)) {
            throw new \InvalidArgumentException('invalid length for $sd_doc_related_object_system when calling APISALESORDERSRVASalesOrderItemRelatedObjectTypeCreate., must be smaller than or equal to 60.');
        }
    ...
    public function setSdDocRelatedObjectReference1($sd_doc_related_object_reference1)
    {
        ...
        if (!is_null($sd_doc_related_object_reference1) && (mb_strlen($sd_doc_related_object_reference1) > 60)) {
            throw new \InvalidArgumentException('invalid length for $sd_doc_related_object_reference1 when calling APISALESORDERSRVASalesOrderItemRelatedObjectTypeCreate., must be smaller than or equal to 60.');
        }
    ...
    public function setSdDocRelatedObjectReference2($sd_doc_related_object_reference2)
    {
        ...
        if (!is_null($sd_doc_related_object_reference2) && (mb_strlen($sd_doc_related_object_reference2) > 60)) {
            throw new \InvalidArgumentException('invalid length for $sd_doc_related_object_reference2 when calling APISALESORDERSRVASalesOrderItemRelatedObjectTypeCreate., must be smaller than or equal to 60.');
        }
