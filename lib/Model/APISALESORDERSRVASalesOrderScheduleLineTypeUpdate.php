<?php
/**
 * APISALESORDERSRVASalesOrderScheduleLineTypeUpdate
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * APISALESORDERSRVASalesOrderScheduleLineTypeUpdate Class Doc Comment
 *
 * @category Class
 * @package  BeLenka\SAP\SalesOrder
 * @author   OpenAPI Generator team
 ...
 */
class APISALESORDERSRVASalesOrderScheduleLineTypeUpdate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'API_SALES_ORDER_SRV.A_SalesOrderScheduleLineType-update';
    ...
    */
    ...
    public function setOrderQuantityUnit($order_quantity_unit)
    {
        ...
        if (!is_null($order_quantity_unit) && (mb_strlen($order_quantity_unit) > 3)) {
            throw new \InvalidArgumentException('invalid length for $order_quantity_unit when calling APISALESORDERSRVASalesOrderScheduleLineTypeUpdate., must be smaller than or equal to 3.');
        }
    ...
    public function setOrderQuantitySapUnit($order_quantity_sap_unit)
    {
        ...
        if (!is_null($order_quantity_sap_unit) && (mb_strlen($order_quantity_sap_unit) > 3)) {
            throw new \InvalidArgumentException('invalid length for $order_quantity_sap_unit when calling APISALESORDERSRVASalesOrderScheduleLineTypeUpdate., must be smaller than or equal to 3.');
        }
    ...
    public function setOrderQuantityIsoUnit($order_quantity_iso_unit)
    {
        ...
        if (!is_null($order_quantity_iso_unit) && (mb_strlen($order_quantity_iso_unit) > 3)) {
            throw new \InvalidArgumentException('invalid length for $order_quantity_iso_unit when calling APISALESORDERSRVASalesOrderScheduleLineTypeUpdate., must be smaller than or equal to 3.');
        }
    ...
    public function setDelivBlockReasonForSchedLine($deliv_block_reason_for_sched_line)
    {
        ...
        if (!is_null($deliv_block_reason_for_sched_line) && (mb_strlen($deliv_block_reason_for_sched_line) > 2)) {
            throw new \InvalidArgumentException('invalid length for $deliv_block_reason_for_sched_line when calling APISALESORDERSRVASalesOrderScheduleLineTypeUpdate., must be smaller than or equal to 2.');
        }
