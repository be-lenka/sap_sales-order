...
/**
 * APISALESORDERSRVASalesOrderItemTypeUpdate Class Doc Comment
 *
 * @category Class
 * @package  BeLenka\SAP\SalesOrder
 * @author   OpenAPI Generator team
 ...
 */
class APISALESORDERSRVASalesOrderItemTypeUpdate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'API_SALES_ORDER_SRV.A_SalesOrderItemType-update';
    ...
    */
    ...
    public function setHigherLevelItem($higher_level_item)
    {
        ...
        if (!is_null($higher_level_item) && (mb_strlen($higher_level_item) > 6)) {
            throw new \InvalidArgumentException('invalid length for $higher_level_item when calling APISALESORDERSRVASalesOrderItemTypeUpdate., must be smaller than or equal to 6.');
        }
    ...
    public function setSalesOrderItemCategory($sales_order_item_category)
    {
        ...
        if (!is_null($sales_order_item_category) && (mb_strlen($sales_order_item_category) > 4)) {
            throw new \InvalidArgumentException('invalid length for $sales_order_item_category when calling APISALESORDERSRVASalesOrderItemTypeUpdate., must be smaller than or equal to 4.');
        }
    ...
    public function setSalesOrderItemText($sales_order_item_text)
    {
        ...
        if (!is_null($sales_order_item_text) && (mb_strlen($sales_order_item_text) > 40)) {
            throw new \InvalidArgumentException('invalid length for $sales_order_item_text when calling APISALESORDERSRVASalesOrderItemTypeUpdate., must be smaller than or equal to 40.');
        }
    ...
    public function setPurchaseOrderByCustomer($purchase_order_by_customer)
    {
        ...
        if (!is_null($purchase_order_by_customer) && (mb_strlen($purchase_order_by_customer) > 35)) {
            throw new \InvalidArgumentException('invalid length for $purchase_order_by_customer when calling APISALESORDERSRVASalesOrderItemTypeUpdate., must be smaller than or equal to 35.');
        }
    ...
    public function setPurchaseOrderByShipToParty($purchase_order_by_ship_to_party)
    {
        ...
        if (!is_null($purchase_order_by_ship_to_party) && (mb_strlen($purchase_order_by_ship_to_party) > 35)) {
            throw new \InvalidArgumentException('invalid length for $purchase_order_by_ship_to_party when calling APISALESORDERSRVASalesOrderItemTypeUpdate., must be smaller than or equal to 35.');
        }
    ...
    public function setUnderlyingPurchaseOrderItem($underlying_purchase_order_item)
    {
        ...
        if (!is_null($underlying_purchase_order_item) && (mb_strlen($underlying_purchase_order_item) > 6)) {
            throw new \InvalidArgumentException('invalid length for $underlying_purchase_order_item when calling APISALESORDERSRVASalesOrderItemTypeUpdate., must be smaller than or equal to 6.');
        }
    ...
    public function setMaterial($material)
    {
        ...
        if (!is_null($material) && (mb_strlen($material) > 40)) {
            throw new \InvalidArgumentException('invalid length for $material when calling APISALESORDERSRVASalesOrderItemTypeUpdate., must be smaller than or equal to 40.');
        }
    ...
    public function setMaterialByCustomer($material_by_customer)
    {
        ...
        if (!is_null($material_by_customer) && (mb_strlen($material_by_customer) > 35)) {
            throw new \InvalidArgumentException('invalid length for $material_by_customer when calling APISALESORDERSRVASalesOrderItemTypeUpdate., must be smaller than or equal to 35.');
        }
    ...
    public function setPricingReferenceMaterial($pricing_reference_material)
    {
        ...
        if (!is_null($pricing_reference_material) && (mb_strlen($pricing_reference_material) > 40)) {
            throw new \InvalidArgumentException('invalid length for $pricing_reference_material when calling APISALESORDERSRVASalesOrderItemTypeUpdate., must be smaller than or equal to 40.');
        }
    ...
    public function setBillingPlan($billing_plan)
    {
        ...
        if (!is_null($billing_plan) && (mb_strlen($billing_plan) > 10)) {
            throw new \InvalidArgumentException('invalid length for $billing_plan when calling APISALESORDERSRVASalesOrderItemTypeUpdate., must be smaller than or equal to 10.');
        }
    ...
    public function setRequestedQuantityUnit($requested_quantity_unit)
    {
        ...
        if (!is_null($requested_quantity_unit) && (mb_strlen($requested_quantity_unit) > 3)) {
            throw new \InvalidArgumentException('invalid length for $requested_quantity_unit when calling APISALESORDERSRVASalesOrderItemTypeUpdate., must be smaller than or equal to 3.');
        }
    ...
    public function setRequestedQuantitySapUnit($requested_quantity_sap_unit)
    {
        ...
        if (!is_null($requested_quantity_sap_unit) && (mb_strlen($requested_quantity_sap_unit) > 3)) {
            throw new \InvalidArgumentException('invalid length for $requested_quantity_sap_unit when calling APISALESORDERSRVASalesOrderItemTypeUpdate., must be smaller than or equal to 3.');
        }
    ...
    public function setRequestedQuantityIsoUnit($requested_quantity_iso_unit)
    {
        ...
        if (!is_null($requested_quantity_iso_unit) && (mb_strlen($requested_quantity_iso_unit) > 3)) {
            throw new \InvalidArgumentException('invalid length for $requested_quantity_iso_unit when calling APISALESORDERSRVASalesOrderItemTypeUpdate., must be smaller than or equal to 3.');
        }
    ...
    public function setItemWeightSapUnit($item_weight_sap_unit)
    {
        ...
        if (!is_null($item_weight_sap_unit) && (mb_strlen($item_weight_sap_unit) > 3)) {
            throw new \InvalidArgumentException('invalid length for $item_weight_sap_unit when calling APISALESORDERSRVASalesOrderItemTypeUpdate., must be smaller than or equal to 3.');
        }
    ...
    public function setItemWeightIsoUnit($item_weight_iso_unit)
    {
        ...
        if (!is_null($item_weight_iso_unit) && (mb_strlen($item_weight_iso_unit) > 3)) {
            throw new \InvalidArgumentException('invalid length for $item_weight_iso_unit when calling APISALESORDERSRVASalesOrderItemTypeUpdate., must be smaller than or equal to 3.');
        }
    ...
    public function setItemVolumeSapUnit($item_volume_sap_unit)
    {
        ...
        if (!is_null($item_volume_sap_unit) && (mb_strlen($item_volume_sap_unit) > 3)) {
            throw new \InvalidArgumentException('invalid length for $item_volume_sap_unit when calling APISALESORDERSRVASalesOrderItemTypeUpdate., must be smaller than or equal to 3.');
        }
    ...
    public function setItemVolumeIsoUnit($item_volume_iso_unit)
    {
        ...
        if (!is_null($item_volume_iso_unit) && (mb_strlen($item_volume_iso_unit) > 3)) {
            throw new \InvalidArgumentException('invalid length for $item_volume_iso_unit when calling APISALESORDERSRVASalesOrderItemTypeUpdate., must be smaller than or equal to 3.');
        }
    ...
    public function setMaterialGroup($material_group)
    {
        ...
        if (!is_null($material_group) && (mb_strlen($material_group) > 9)) {
            throw new \InvalidArgumentException('invalid length for $material_group when calling APISALESORDERSRVASalesOrderItemTypeUpdate., must be smaller than or equal to 9.');
        }
    ...
    public function setMaterialPricingGroup($material_pricing_group)
    {
        ...
        if (!is_null($material_pricing_group) && (mb_strlen($material_pricing_group) > 2)) {
            throw new \InvalidArgumentException('invalid length for $material_pricing_group when calling APISALESORDERSRVASalesOrderItemTypeUpdate., must be smaller than or equal to 2.');
        }
    ...
    public function setAdditionalMaterialGroup1($additional_material_group1)
    {
        ...
        if (!is_null($additional_material_group1) && (mb_strlen($additional_material_group1) > 3)) {
            throw new \InvalidArgumentException('invalid length for $additional_material_group1 when calling APISALESORDERSRVASalesOrderItemTypeUpdate., must be smaller than or equal to 3.');
        }
    ...
    public function setAdditionalMaterialGroup2($additional_material_group2)
    {
        ...
        if (!is_null($additional_material_group2) && (mb_strlen($additional_material_group2) > 3)) {
            throw new \InvalidArgumentException('invalid length for $additional_material_group2 when calling APISALESORDERSRVASalesOrderItemTypeUpdate., must be smaller than or equal to 3.');
        }
    ...
    public function setAdditionalMaterialGroup3($additional_material_group3)
    {
        ...
        if (!is_null($additional_material_group3) && (mb_strlen($additional_material_group3) > 3)) {
            throw new \InvalidArgumentException('invalid length for $additional_material_group3 when calling APISALESORDERSRVASalesOrderItemTypeUpdate., must be smaller than or equal to 3.');
        }
    ...
    public function setAdditionalMaterialGroup4($additional_material_group4)
    {
        ...
        if (!is_null($additional_material_group4) && (mb_strlen($additional_material_group4) > 3)) {
            throw new \InvalidArgumentException('invalid length for $additional_material_group4 when calling APISALESORDERSRVASalesOrderItemTypeUpdate., must be smaller than or equal to 3.');
        }
    ...
    public function setAdditionalMaterialGroup5($additional_material_group5)
    {
        ...
        if (!is_null($additional_material_group5) && (mb_strlen($additional_material_group5) > 3)) {
            throw new \InvalidArgumentException('invalid length for $additional_material_group5 when calling APISALESORDERSRVASalesOrderItemTypeUpdate., must be smaller than or equal to 3.');
        }
    ...
    public function setContractAccount($contract_account)
    {
        ...
        if (!is_null($contract_account) && (mb_strlen($contract_account) > 12)) {
            throw new \InvalidArgumentException('invalid length for $contract_account when calling APISALESORDERSRVASalesOrderItemTypeUpdate., must be smaller than or equal to 12.');
        }
    ...
    public function setAdditionalValueDays($additional_value_days)
    {
        ...
        if (!is_null($additional_value_days) && (mb_strlen($additional_value_days) > 2)) {
            throw new \InvalidArgumentException('invalid length for $additional_value_days when calling APISALESORDERSRVASalesOrderItemTypeUpdate., must be smaller than or equal to 2.');
        }
    ...
    public function setBatch($batch)
    {
        ...
        if (!is_null($batch) && (mb_strlen($batch) > 10)) {
            throw new \InvalidArgumentException('invalid length for $batch when calling APISALESORDERSRVASalesOrderItemTypeUpdate., must be smaller than or equal to 10.');
        }
    ...
    public function setProductionPlant($production_plant)
    {
        ...
        if (!is_null($production_plant) && (mb_strlen($production_plant) > 4)) {
            throw new \InvalidArgumentException('invalid length for $production_plant when calling APISALESORDERSRVASalesOrderItemTypeUpdate., must be smaller than or equal to 4.');
        }
    ...
    public function setStorageLocation($storage_location)
    {
        ...
        if (!is_null($storage_location) && (mb_strlen($storage_location) > 4)) {
            throw new \InvalidArgumentException('invalid length for $storage_location when calling APISALESORDERSRVASalesOrderItemTypeUpdate., must be smaller than or equal to 4.');
        }
    ...
    public function setDeliveryGroup($delivery_group)
    {
        ...
        if (!is_null($delivery_group) && (mb_strlen($delivery_group) > 3)) {
            throw new \InvalidArgumentException('invalid length for $delivery_group when calling APISALESORDERSRVASalesOrderItemTypeUpdate., must be smaller than or equal to 3.');
        }
    ...
    public function setShippingPoint($shipping_point)
    {
        ...
        if (!is_null($shipping_point) && (mb_strlen($shipping_point) > 4)) {
            throw new \InvalidArgumentException('invalid length for $shipping_point when calling APISALESORDERSRVASalesOrderItemTypeUpdate., must be smaller than or equal to 4.');
        }
    ...
    public function setShippingType($shipping_type)
    {
        ...
        if (!is_null($shipping_type) && (mb_strlen($shipping_type) > 2)) {
            throw new \InvalidArgumentException('invalid length for $shipping_type when calling APISALESORDERSRVASalesOrderItemTypeUpdate., must be smaller than or equal to 2.');
        }
    ...
    public function setDeliveryPriority($delivery_priority)
    {
        ...
        if (!is_null($delivery_priority) && (mb_strlen($delivery_priority) > 2)) {
            throw new \InvalidArgumentException('invalid length for $delivery_priority when calling APISALESORDERSRVASalesOrderItemTypeUpdate., must be smaller than or equal to 2.');
        }
    ...
    public function setDeliveryDateTypeRule($delivery_date_type_rule)
    {
        ...
        if (!is_null($delivery_date_type_rule) && (mb_strlen($delivery_date_type_rule) > 1)) {
            throw new \InvalidArgumentException('invalid length for $delivery_date_type_rule when calling APISALESORDERSRVASalesOrderItemTypeUpdate., must be smaller than or equal to 1.');
        }
    ...
    public function setIncotermsClassification($incoterms_classification)
    {
        ...
        if (!is_null($incoterms_classification) && (mb_strlen($incoterms_classification) > 3)) {
            throw new \InvalidArgumentException('invalid length for $incoterms_classification when calling APISALESORDERSRVASalesOrderItemTypeUpdate., must be smaller than or equal to 3.');
        }
    ...
    public function setIncotermsTransferLocation($incoterms_transfer_location)
    {
        ...
        if (!is_null($incoterms_transfer_location) && (mb_strlen($incoterms_transfer_location) > 28)) {
            throw new \InvalidArgumentException('invalid length for $incoterms_transfer_location when calling APISALESORDERSRVASalesOrderItemTypeUpdate., must be smaller than or equal to 28.');
        }
    ...
    public function setIncotermsLocation1($incoterms_location1)
    {
        ...
        if (!is_null($incoterms_location1) && (mb_strlen($incoterms_location1) > 70)) {
            throw new \InvalidArgumentException('invalid length for $incoterms_location1 when calling APISALESORDERSRVASalesOrderItemTypeUpdate., must be smaller than or equal to 70.');
        }
    ...
    public function setIncotermsLocation2($incoterms_location2)
    {
        ...
        if (!is_null($incoterms_location2) && (mb_strlen($incoterms_location2) > 70)) {
            throw new \InvalidArgumentException('invalid length for $incoterms_location2 when calling APISALESORDERSRVASalesOrderItemTypeUpdate., must be smaller than or equal to 70.');
        }
    ...
    public function setProductTaxClassification1($product_tax_classification1)
    {
        ...
        if (!is_null($product_tax_classification1) && (mb_strlen($product_tax_classification1) > 1)) {
            throw new \InvalidArgumentException('invalid length for $product_tax_classification1 when calling APISALESORDERSRVASalesOrderItemTypeUpdate., must be smaller than or equal to 1.');
        }
    ...
    public function setProductTaxClassification2($product_tax_classification2)
    {
        ...
        if (!is_null($product_tax_classification2) && (mb_strlen($product_tax_classification2) > 1)) {
            throw new \InvalidArgumentException('invalid length for $product_tax_classification2 when calling APISALESORDERSRVASalesOrderItemTypeUpdate., must be smaller than or equal to 1.');
        }
    ...
    public function setProductTaxClassification3($product_tax_classification3)
    {
        ...
        if (!is_null($product_tax_classification3) && (mb_strlen($product_tax_classification3) > 1)) {
            throw new \InvalidArgumentException('invalid length for $product_tax_classification3 when calling APISALESORDERSRVASalesOrderItemTypeUpdate., must be smaller than or equal to 1.');
        }
    ...
    public function setProductTaxClassification4($product_tax_classification4)
    {
        ...
        if (!is_null($product_tax_classification4) && (mb_strlen($product_tax_classification4) > 1)) {
            throw new \InvalidArgumentException('invalid length for $product_tax_classification4 when calling APISALESORDERSRVASalesOrderItemTypeUpdate., must be smaller than or equal to 1.');
        }
    ...
    public function setProductTaxClassification5($product_tax_classification5)
    {
        ...
        if (!is_null($product_tax_classification5) && (mb_strlen($product_tax_classification5) > 1)) {
            throw new \InvalidArgumentException('invalid length for $product_tax_classification5 when calling APISALESORDERSRVASalesOrderItemTypeUpdate., must be smaller than or equal to 1.');
        }
    ...
    public function setProductTaxClassification6($product_tax_classification6)
    {
        ...
        if (!is_null($product_tax_classification6) && (mb_strlen($product_tax_classification6) > 1)) {
            throw new \InvalidArgumentException('invalid length for $product_tax_classification6 when calling APISALESORDERSRVASalesOrderItemTypeUpdate., must be smaller than or equal to 1.');
        }
    ...
    public function setProductTaxClassification7($product_tax_classification7)
    {
        ...
        if (!is_null($product_tax_classification7) && (mb_strlen($product_tax_classification7) > 1)) {
            throw new \InvalidArgumentException('invalid length for $product_tax_classification7 when calling APISALESORDERSRVASalesOrderItemTypeUpdate., must be smaller than or equal to 1.');
        }
    ...
    public function setProductTaxClassification8($product_tax_classification8)
    {
        ...
        if (!is_null($product_tax_classification8) && (mb_strlen($product_tax_classification8) > 1)) {
            throw new \InvalidArgumentException('invalid length for $product_tax_classification8 when calling APISALESORDERSRVASalesOrderItemTypeUpdate., must be smaller than or equal to 1.');
        }
    ...
    public function setProductTaxClassification9($product_tax_classification9)
    {
        ...
        if (!is_null($product_tax_classification9) && (mb_strlen($product_tax_classification9) > 1)) {
            throw new \InvalidArgumentException('invalid length for $product_tax_classification9 when calling APISALESORDERSRVASalesOrderItemTypeUpdate., must be smaller than or equal to 1.');
        }
    ...
    public function setMatlAccountAssignmentGroup($matl_account_assignment_group)
    {
        ...
        if (!is_null($matl_account_assignment_group) && (mb_strlen($matl_account_assignment_group) > 2)) {
            throw new \InvalidArgumentException('invalid length for $matl_account_assignment_group when calling APISALESORDERSRVASalesOrderItemTypeUpdate., must be smaller than or equal to 2.');
        }
    ...
    public function setCustomerPaymentTerms($customer_payment_terms)
    {
        ...
        if (!is_null($customer_payment_terms) && (mb_strlen($customer_payment_terms) > 4)) {
            throw new \InvalidArgumentException('invalid length for $customer_payment_terms when calling APISALESORDERSRVASalesOrderItemTypeUpdate., must be smaller than or equal to 4.');
        }
    ...
    public function setCustomerGroup($customer_group)
    {
        ...
        if (!is_null($customer_group) && (mb_strlen($customer_group) > 2)) {
            throw new \InvalidArgumentException('invalid length for $customer_group when calling APISALESORDERSRVASalesOrderItemTypeUpdate., must be smaller than or equal to 2.');
        }
    ...
    public function setSalesDocumentRjcnReason($sales_document_rjcn_reason)
    {
        ...
        if (!is_null($sales_document_rjcn_reason) && (mb_strlen($sales_document_rjcn_reason) > 2)) {
            throw new \InvalidArgumentException('invalid length for $sales_document_rjcn_reason when calling APISALESORDERSRVASalesOrderItemTypeUpdate., must be smaller than or equal to 2.');
        }
    ...
    public function setItemBillingBlockReason($item_billing_block_reason)
    {
        ...
        if (!is_null($item_billing_block_reason) && (mb_strlen($item_billing_block_reason) > 2)) {
            throw new \InvalidArgumentException('invalid length for $item_billing_block_reason when calling APISALESORDERSRVASalesOrderItemTypeUpdate., must be smaller than or equal to 2.');
        }
    ...
    public function setWbsElement($wbs_element)
    {
        ...
        if (!is_null($wbs_element) && (mb_strlen($wbs_element) > 24)) {
            throw new \InvalidArgumentException('invalid length for $wbs_element when calling APISALESORDERSRVASalesOrderItemTypeUpdate., must be smaller than or equal to 24.');
        }
    ...
    public function setProfitCenter($profit_center)
    {
        ...
        if (!is_null($profit_center) && (mb_strlen($profit_center) > 10)) {
            throw new \InvalidArgumentException('invalid length for $profit_center when calling APISALESORDERSRVASalesOrderItemTypeUpdate., must be smaller than or equal to 10.');
        }
    ...
    public function setReferenceSdDocument($reference_sd_document)
    {
        ...
        if (!is_null($reference_sd_document) && (mb_strlen($reference_sd_document) > 10)) {
            throw new \InvalidArgumentException('invalid length for $reference_sd_document when calling APISALESORDERSRVASalesOrderItemTypeUpdate., must be smaller than or equal to 10.');
        }
    ...
    public function setReferenceSdDocumentItem($reference_sd_document_item)
    {
        ...
        if (!is_null($reference_sd_document_item) && (mb_strlen($reference_sd_document_item) > 6)) {
            throw new \InvalidArgumentException('invalid length for $reference_sd_document_item when calling APISALESORDERSRVASalesOrderItemTypeUpdate., must be smaller than or equal to 6.');
        }
