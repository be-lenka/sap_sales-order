...
/**
 * APISALESORDERSRVASalesOrderScheduleLineType Class Doc Comment
 *
 * @category Class
 * @package  BeLenka\SAP\SalesOrder
 * @author   OpenAPI Generator team
 ...
 */
class APISALESORDERSRVASalesOrderScheduleLineType implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'API_SALES_ORDER_SRV.A_SalesOrderScheduleLineType';
    ...
    */
    ...
    public function setSalesOrder($sales_order)
    {
        ...
        if ((mb_strlen($sales_order) > 10)) {
            throw new \InvalidArgumentException('invalid length for $sales_order when calling APISALESORDERSRVASalesOrderScheduleLineType., must be smaller than or equal to 10.');
        }
    ...
    public function setSalesOrderItem($sales_order_item)
    {
        ...
        if ((mb_strlen($sales_order_item) > 6)) {
            throw new \InvalidArgumentException('invalid length for $sales_order_item when calling APISALESORDERSRVASalesOrderScheduleLineType., must be smaller than or equal to 6.');
        }
    ...
    public function setScheduleLine($schedule_line)
    {
        ...
        if ((mb_strlen($schedule_line) > 4)) {
            throw new \InvalidArgumentException('invalid length for $schedule_line when calling APISALESORDERSRVASalesOrderScheduleLineType., must be smaller than or equal to 4.');
        }
    ...
    public function setOrderQuantityUnit($order_quantity_unit)
    {
        ...
        if (!is_null($order_quantity_unit) && (mb_strlen($order_quantity_unit) > 3)) {
            throw new \InvalidArgumentException('invalid length for $order_quantity_unit when calling APISALESORDERSRVASalesOrderScheduleLineType., must be smaller than or equal to 3.');
        }
    ...
    public function setOrderQuantitySapUnit($order_quantity_sap_unit)
    {
        ...
        if (!is_null($order_quantity_sap_unit) && (mb_strlen($order_quantity_sap_unit) > 3)) {
            throw new \InvalidArgumentException('invalid length for $order_quantity_sap_unit when calling APISALESORDERSRVASalesOrderScheduleLineType., must be smaller than or equal to 3.');
        }
    ...
    public function setOrderQuantityIsoUnit($order_quantity_iso_unit)
    {
        ...
        if (!is_null($order_quantity_iso_unit) && (mb_strlen($order_quantity_iso_unit) > 3)) {
            throw new \InvalidArgumentException('invalid length for $order_quantity_iso_unit when calling APISALESORDERSRVASalesOrderScheduleLineType., must be smaller than or equal to 3.');
        }
    ...
    public function setDelivBlockReasonForSchedLine($deliv_block_reason_for_sched_line)
    {
        ...
        if (!is_null($deliv_block_reason_for_sched_line) && (mb_strlen($deliv_block_reason_for_sched_line) > 2)) {
            throw new \InvalidArgumentException('invalid length for $deliv_block_reason_for_sched_line when calling APISALESORDERSRVASalesOrderScheduleLineType., must be smaller than or equal to 2.');
        }
