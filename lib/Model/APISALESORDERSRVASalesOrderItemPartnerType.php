...
/**
 * APISALESORDERSRVASalesOrderItemPartnerType Class Doc Comment
 *
 * @category Class
 * @package  BeLenka\SAP\SalesOrder
 * @author   OpenAPI Generator team
 ...
 */
class APISALESORDERSRVASalesOrderItemPartnerType implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'API_SALES_ORDER_SRV.A_SalesOrderItemPartnerType';
    ...
    protected static $openAPITypes = [
        ...
        'to_address' => '\BeLenka\SAP\SalesOrder\Model\APISALESORDERSRVASalesOrderItemPartnerTypeToAddress',
    ...
    */
    ...
    public function setSalesOrder($sales_order)
    {
        ...
        if ((mb_strlen($sales_order) > 10)) {
            throw new \InvalidArgumentException('invalid length for $sales_order when calling APISALESORDERSRVASalesOrderItemPartnerType., must be smaller than or equal to 10.');
        }
    ...
    public function setSalesOrderItem($sales_order_item)
    {
        ...
        if ((mb_strlen($sales_order_item) > 6)) {
            throw new \InvalidArgumentException('invalid length for $sales_order_item when calling APISALESORDERSRVASalesOrderItemPartnerType., must be smaller than or equal to 6.');
        }
    ...
    public function setPartnerFunction($partner_function)
    {
        ...
        if ((mb_strlen($partner_function) > 2)) {
            throw new \InvalidArgumentException('invalid length for $partner_function when calling APISALESORDERSRVASalesOrderItemPartnerType., must be smaller than or equal to 2.');
        }
    ...
    public function setPartnerFunctionInternalCode($partner_function_internal_code)
    {
        ...
        if (!is_null($partner_function_internal_code) && (mb_strlen($partner_function_internal_code) > 2)) {
            throw new \InvalidArgumentException('invalid length for $partner_function_internal_code when calling APISALESORDERSRVASalesOrderItemPartnerType., must be smaller than or equal to 2.');
        }
    ...
    public function setCustomer($customer)
    {
        ...
        if (!is_null($customer) && (mb_strlen($customer) > 10)) {
            throw new \InvalidArgumentException('invalid length for $customer when calling APISALESORDERSRVASalesOrderItemPartnerType., must be smaller than or equal to 10.');
        }
    ...
    public function setSupplier($supplier)
    {
        ...
        if (!is_null($supplier) && (mb_strlen($supplier) > 10)) {
            throw new \InvalidArgumentException('invalid length for $supplier when calling APISALESORDERSRVASalesOrderItemPartnerType., must be smaller than or equal to 10.');
        }
    ...
    public function setPersonnel($personnel)
    {
        ...
        if (!is_null($personnel) && (mb_strlen($personnel) > 8)) {
            throw new \InvalidArgumentException('invalid length for $personnel when calling APISALESORDERSRVASalesOrderItemPartnerType., must be smaller than or equal to 8.');
        }
    ...
    public function setContactPerson($contact_person)
    {
        ...
        if (!is_null($contact_person) && (mb_strlen($contact_person) > 10)) {
            throw new \InvalidArgumentException('invalid length for $contact_person when calling APISALESORDERSRVASalesOrderItemPartnerType., must be smaller than or equal to 10.');
        }
    ...
    public function setReferenceBusinessPartner($reference_business_partner)
    {
        ...
        if (!is_null($reference_business_partner) && (mb_strlen($reference_business_partner) > 10)) {
            throw new \InvalidArgumentException('invalid length for $reference_business_partner when calling APISALESORDERSRVASalesOrderItemPartnerType., must be smaller than or equal to 10.');
        }
    ...
    public function setAddressId($address_id)
    {
        ...
        if (!is_null($address_id) && (mb_strlen($address_id) > 10)) {
            throw new \InvalidArgumentException('invalid length for $address_id when calling APISALESORDERSRVASalesOrderItemPartnerType., must be smaller than or equal to 10.');
        }
    ...
    public function setVatRegistration($vat_registration)
    {
        ...
        if (!is_null($vat_registration) && (mb_strlen($vat_registration) > 20)) {
            throw new \InvalidArgumentException('invalid length for $vat_registration when calling APISALESORDERSRVASalesOrderItemPartnerType., must be smaller than or equal to 20.');
        }
     ...
     * Gets to_address
     *
     * @return \BeLenka\SAP\SalesOrder\Model\APISALESORDERSRVASalesOrderItemPartnerTypeToAddress|null
     */
     ...
     * Sets to_address
     *
     * @param \BeLenka\SAP\SalesOrder\Model\APISALESORDERSRVASalesOrderItemPartnerTypeToAddress|null $to_address to_address
     *
     * @return self
     */
