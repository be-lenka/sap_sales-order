<?php
/**
 * APISALESORDERSRVASalesOrderBillingPlanItemTypeCreate
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * APISALESORDERSRVASalesOrderBillingPlanItemTypeCreate Class Doc Comment
 *
 * @category Class
 * @package  BeLenka\SAP\SalesOrder
 * @author   OpenAPI Generator team
 ...
 */
class APISALESORDERSRVASalesOrderBillingPlanItemTypeCreate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'API_SALES_ORDER_SRV.A_SalesOrderBillingPlanItemType-create';
    ...
    */
    ...
    public function setBillingPlanDateCategory($billing_plan_date_category)
    {
        ...
        if (!is_null($billing_plan_date_category) && (mb_strlen($billing_plan_date_category) > 2)) {
            throw new \InvalidArgumentException('invalid length for $billing_plan_date_category when calling APISALESORDERSRVASalesOrderBillingPlanItemTypeCreate., must be smaller than or equal to 2.');
        }
    ...
    public function setCustomerPaymentTerms($customer_payment_terms)
    {
        ...
        if (!is_null($customer_payment_terms) && (mb_strlen($customer_payment_terms) > 4)) {
            throw new \InvalidArgumentException('invalid length for $customer_payment_terms when calling APISALESORDERSRVASalesOrderBillingPlanItemTypeCreate., must be smaller than or equal to 4.');
        }
    ...
    public function setProposedBillingDocumentType($proposed_billing_document_type)
    {
        ...
        if (!is_null($proposed_billing_document_type) && (mb_strlen($proposed_billing_document_type) > 4)) {
            throw new \InvalidArgumentException('invalid length for $proposed_billing_document_type when calling APISALESORDERSRVASalesOrderBillingPlanItemTypeCreate., must be smaller than or equal to 4.');
        }
    ...
    public function setBillingPlanDateDescriptionCode($billing_plan_date_description_code)
    {
        ...
        if (!is_null($billing_plan_date_description_code) && (mb_strlen($billing_plan_date_description_code) > 4)) {
            throw new \InvalidArgumentException('invalid length for $billing_plan_date_description_code when calling APISALESORDERSRVASalesOrderBillingPlanItemTypeCreate., must be smaller than or equal to 4.');
        }
    ...
    public function setBillingBlockReason($billing_block_reason)
    {
        ...
        if (!is_null($billing_block_reason) && (mb_strlen($billing_block_reason) > 2)) {
            throw new \InvalidArgumentException('invalid length for $billing_block_reason when calling APISALESORDERSRVASalesOrderBillingPlanItemTypeCreate., must be smaller than or equal to 2.');
        }
