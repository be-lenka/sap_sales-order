...
/**
 * APISALESORDERSRVASalesOrderTypeUpdate Class Doc Comment
 *
 * @category Class
 * @package  BeLenka\SAP\SalesOrder
 * @author   OpenAPI Generator team
 ...
 */
class APISALESORDERSRVASalesOrderTypeUpdate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'API_SALES_ORDER_SRV.A_SalesOrderType-update';
    ...
    */
    ...
    public function setSalesOrderType($sales_order_type)
    {
        ...
        if (!is_null($sales_order_type) && (mb_strlen($sales_order_type) > 4)) {
            throw new \InvalidArgumentException('invalid length for $sales_order_type when calling APISALESORDERSRVASalesOrderTypeUpdate., must be smaller than or equal to 4.');
        }
    ...
    public function setSalesOrganization($sales_organization)
    {
        ...
        if (!is_null($sales_organization) && (mb_strlen($sales_organization) > 4)) {
            throw new \InvalidArgumentException('invalid length for $sales_organization when calling APISALESORDERSRVASalesOrderTypeUpdate., must be smaller than or equal to 4.');
        }
    ...
    public function setDistributionChannel($distribution_channel)
    {
        ...
        if (!is_null($distribution_channel) && (mb_strlen($distribution_channel) > 2)) {
            throw new \InvalidArgumentException('invalid length for $distribution_channel when calling APISALESORDERSRVASalesOrderTypeUpdate., must be smaller than or equal to 2.');
        }
    ...
    public function setOrganizationDivision($organization_division)
    {
        ...
        if (!is_null($organization_division) && (mb_strlen($organization_division) > 2)) {
            throw new \InvalidArgumentException('invalid length for $organization_division when calling APISALESORDERSRVASalesOrderTypeUpdate., must be smaller than or equal to 2.');
        }
    ...
    public function setSalesGroup($sales_group)
    {
        ...
        if (!is_null($sales_group) && (mb_strlen($sales_group) > 3)) {
            throw new \InvalidArgumentException('invalid length for $sales_group when calling APISALESORDERSRVASalesOrderTypeUpdate., must be smaller than or equal to 3.');
        }
    ...
    public function setSalesOffice($sales_office)
    {
        ...
        if (!is_null($sales_office) && (mb_strlen($sales_office) > 4)) {
            throw new \InvalidArgumentException('invalid length for $sales_office when calling APISALESORDERSRVASalesOrderTypeUpdate., must be smaller than or equal to 4.');
        }
    ...
    public function setSalesDistrict($sales_district)
    {
        ...
        if (!is_null($sales_district) && (mb_strlen($sales_district) > 6)) {
            throw new \InvalidArgumentException('invalid length for $sales_district when calling APISALESORDERSRVASalesOrderTypeUpdate., must be smaller than or equal to 6.');
        }
    ...
    public function setSoldToParty($sold_to_party)
    {
        ...
        if (!is_null($sold_to_party) && (mb_strlen($sold_to_party) > 10)) {
            throw new \InvalidArgumentException('invalid length for $sold_to_party when calling APISALESORDERSRVASalesOrderTypeUpdate., must be smaller than or equal to 10.');
        }
    ...
    public function setPurchaseOrderByCustomer($purchase_order_by_customer)
    {
        ...
        if (!is_null($purchase_order_by_customer) && (mb_strlen($purchase_order_by_customer) > 35)) {
            throw new \InvalidArgumentException('invalid length for $purchase_order_by_customer when calling APISALESORDERSRVASalesOrderTypeUpdate., must be smaller than or equal to 35.');
        }
    ...
    public function setPurchaseOrderByShipToParty($purchase_order_by_ship_to_party)
    {
        ...
        if (!is_null($purchase_order_by_ship_to_party) && (mb_strlen($purchase_order_by_ship_to_party) > 35)) {
            throw new \InvalidArgumentException('invalid length for $purchase_order_by_ship_to_party when calling APISALESORDERSRVASalesOrderTypeUpdate., must be smaller than or equal to 35.');
        }
    ...
    public function setCustomerPurchaseOrderType($customer_purchase_order_type)
    {
        ...
        if (!is_null($customer_purchase_order_type) && (mb_strlen($customer_purchase_order_type) > 4)) {
            throw new \InvalidArgumentException('invalid length for $customer_purchase_order_type when calling APISALESORDERSRVASalesOrderTypeUpdate., must be smaller than or equal to 4.');
        }
    ...
    public function setTransactionCurrency($transaction_currency)
    {
        ...
        if (!is_null($transaction_currency) && (mb_strlen($transaction_currency) > 5)) {
            throw new \InvalidArgumentException('invalid length for $transaction_currency when calling APISALESORDERSRVASalesOrderTypeUpdate., must be smaller than or equal to 5.');
        }
    ...
    public function setSdDocumentReason($sd_document_reason)
    {
        ...
        if (!is_null($sd_document_reason) && (mb_strlen($sd_document_reason) > 3)) {
            throw new \InvalidArgumentException('invalid length for $sd_document_reason when calling APISALESORDERSRVASalesOrderTypeUpdate., must be smaller than or equal to 3.');
        }
    ...
    public function setBillingPlan($billing_plan)
    {
        ...
        if (!is_null($billing_plan) && (mb_strlen($billing_plan) > 10)) {
            throw new \InvalidArgumentException('invalid length for $billing_plan when calling APISALESORDERSRVASalesOrderTypeUpdate., must be smaller than or equal to 10.');
        }
    ...
    public function setShippingCondition($shipping_condition)
    {
        ...
        if (!is_null($shipping_condition) && (mb_strlen($shipping_condition) > 2)) {
            throw new \InvalidArgumentException('invalid length for $shipping_condition when calling APISALESORDERSRVASalesOrderTypeUpdate., must be smaller than or equal to 2.');
        }
    ...
    public function setShippingType($shipping_type)
    {
        ...
        if (!is_null($shipping_type) && (mb_strlen($shipping_type) > 2)) {
            throw new \InvalidArgumentException('invalid length for $shipping_type when calling APISALESORDERSRVASalesOrderTypeUpdate., must be smaller than or equal to 2.');
        }
    ...
    public function setHeaderBillingBlockReason($header_billing_block_reason)
    {
        ...
        if (!is_null($header_billing_block_reason) && (mb_strlen($header_billing_block_reason) > 2)) {
            throw new \InvalidArgumentException('invalid length for $header_billing_block_reason when calling APISALESORDERSRVASalesOrderTypeUpdate., must be smaller than or equal to 2.');
        }
    ...
    public function setDeliveryBlockReason($delivery_block_reason)
    {
        ...
        if (!is_null($delivery_block_reason) && (mb_strlen($delivery_block_reason) > 2)) {
            throw new \InvalidArgumentException('invalid length for $delivery_block_reason when calling APISALESORDERSRVASalesOrderTypeUpdate., must be smaller than or equal to 2.');
        }
    ...
    public function setDeliveryDateTypeRule($delivery_date_type_rule)
    {
        ...
        if (!is_null($delivery_date_type_rule) && (mb_strlen($delivery_date_type_rule) > 1)) {
            throw new \InvalidArgumentException('invalid length for $delivery_date_type_rule when calling APISALESORDERSRVASalesOrderTypeUpdate., must be smaller than or equal to 1.');
        }
    ...
    public function setIncotermsClassification($incoterms_classification)
    {
        ...
        if (!is_null($incoterms_classification) && (mb_strlen($incoterms_classification) > 3)) {
            throw new \InvalidArgumentException('invalid length for $incoterms_classification when calling APISALESORDERSRVASalesOrderTypeUpdate., must be smaller than or equal to 3.');
        }
    ...
    public function setIncotermsTransferLocation($incoterms_transfer_location)
    {
        ...
        if (!is_null($incoterms_transfer_location) && (mb_strlen($incoterms_transfer_location) > 28)) {
            throw new \InvalidArgumentException('invalid length for $incoterms_transfer_location when calling APISALESORDERSRVASalesOrderTypeUpdate., must be smaller than or equal to 28.');
        }
    ...
    public function setIncotermsLocation1($incoterms_location1)
    {
        ...
        if (!is_null($incoterms_location1) && (mb_strlen($incoterms_location1) > 70)) {
            throw new \InvalidArgumentException('invalid length for $incoterms_location1 when calling APISALESORDERSRVASalesOrderTypeUpdate., must be smaller than or equal to 70.');
        }
    ...
    public function setIncotermsLocation2($incoterms_location2)
    {
        ...
        if (!is_null($incoterms_location2) && (mb_strlen($incoterms_location2) > 70)) {
            throw new \InvalidArgumentException('invalid length for $incoterms_location2 when calling APISALESORDERSRVASalesOrderTypeUpdate., must be smaller than or equal to 70.');
        }
    ...
    public function setIncotermsVersion($incoterms_version)
    {
        ...
        if (!is_null($incoterms_version) && (mb_strlen($incoterms_version) > 4)) {
            throw new \InvalidArgumentException('invalid length for $incoterms_version when calling APISALESORDERSRVASalesOrderTypeUpdate., must be smaller than or equal to 4.');
        }
    ...
    public function setCustomerPriceGroup($customer_price_group)
    {
        ...
        if (!is_null($customer_price_group) && (mb_strlen($customer_price_group) > 2)) {
            throw new \InvalidArgumentException('invalid length for $customer_price_group when calling APISALESORDERSRVASalesOrderTypeUpdate., must be smaller than or equal to 2.');
        }
    ...
    public function setPriceListType($price_list_type)
    {
        ...
        if (!is_null($price_list_type) && (mb_strlen($price_list_type) > 2)) {
            throw new \InvalidArgumentException('invalid length for $price_list_type when calling APISALESORDERSRVASalesOrderTypeUpdate., must be smaller than or equal to 2.');
        }
    ...
    public function setCustomerPaymentTerms($customer_payment_terms)
    {
        ...
        if (!is_null($customer_payment_terms) && (mb_strlen($customer_payment_terms) > 4)) {
            throw new \InvalidArgumentException('invalid length for $customer_payment_terms when calling APISALESORDERSRVASalesOrderTypeUpdate., must be smaller than or equal to 4.');
        }
    ...
    public function setPaymentMethod($payment_method)
    {
        ...
        if (!is_null($payment_method) && (mb_strlen($payment_method) > 1)) {
            throw new \InvalidArgumentException('invalid length for $payment_method when calling APISALESORDERSRVASalesOrderTypeUpdate., must be smaller than or equal to 1.');
        }
    ...
    public function setAssignmentReference($assignment_reference)
    {
        ...
        if (!is_null($assignment_reference) && (mb_strlen($assignment_reference) > 18)) {
            throw new \InvalidArgumentException('invalid length for $assignment_reference when calling APISALESORDERSRVASalesOrderTypeUpdate., must be smaller than or equal to 18.');
        }
    ...
    public function setReferenceSdDocument($reference_sd_document)
    {
        ...
        if (!is_null($reference_sd_document) && (mb_strlen($reference_sd_document) > 10)) {
            throw new \InvalidArgumentException('invalid length for $reference_sd_document when calling APISALESORDERSRVASalesOrderTypeUpdate., must be smaller than or equal to 10.');
        }
    ...
    public function setAccountingDocExternalReference($accounting_doc_external_reference)
    {
        ...
        if (!is_null($accounting_doc_external_reference) && (mb_strlen($accounting_doc_external_reference) > 16)) {
            throw new \InvalidArgumentException('invalid length for $accounting_doc_external_reference when calling APISALESORDERSRVASalesOrderTypeUpdate., must be smaller than or equal to 16.');
        }
    ...
    public function setCustomerAccountAssignmentGroup($customer_account_assignment_group)
    {
        ...
        if (!is_null($customer_account_assignment_group) && (mb_strlen($customer_account_assignment_group) > 2)) {
            throw new \InvalidArgumentException('invalid length for $customer_account_assignment_group when calling APISALESORDERSRVASalesOrderTypeUpdate., must be smaller than or equal to 2.');
        }
    ...
    public function setCustomerGroup($customer_group)
    {
        ...
        if (!is_null($customer_group) && (mb_strlen($customer_group) > 2)) {
            throw new \InvalidArgumentException('invalid length for $customer_group when calling APISALESORDERSRVASalesOrderTypeUpdate., must be smaller than or equal to 2.');
        }
    ...
    public function setAdditionalCustomerGroup1($additional_customer_group1)
    {
        ...
        if (!is_null($additional_customer_group1) && (mb_strlen($additional_customer_group1) > 3)) {
            throw new \InvalidArgumentException('invalid length for $additional_customer_group1 when calling APISALESORDERSRVASalesOrderTypeUpdate., must be smaller than or equal to 3.');
        }
    ...
    public function setAdditionalCustomerGroup2($additional_customer_group2)
    {
        ...
        if (!is_null($additional_customer_group2) && (mb_strlen($additional_customer_group2) > 3)) {
            throw new \InvalidArgumentException('invalid length for $additional_customer_group2 when calling APISALESORDERSRVASalesOrderTypeUpdate., must be smaller than or equal to 3.');
        }
    ...
    public function setAdditionalCustomerGroup3($additional_customer_group3)
    {
        ...
        if (!is_null($additional_customer_group3) && (mb_strlen($additional_customer_group3) > 3)) {
            throw new \InvalidArgumentException('invalid length for $additional_customer_group3 when calling APISALESORDERSRVASalesOrderTypeUpdate., must be smaller than or equal to 3.');
        }
    ...
    public function setAdditionalCustomerGroup4($additional_customer_group4)
    {
        ...
        if (!is_null($additional_customer_group4) && (mb_strlen($additional_customer_group4) > 3)) {
            throw new \InvalidArgumentException('invalid length for $additional_customer_group4 when calling APISALESORDERSRVASalesOrderTypeUpdate., must be smaller than or equal to 3.');
        }
    ...
    public function setAdditionalCustomerGroup5($additional_customer_group5)
    {
        ...
        if (!is_null($additional_customer_group5) && (mb_strlen($additional_customer_group5) > 3)) {
            throw new \InvalidArgumentException('invalid length for $additional_customer_group5 when calling APISALESORDERSRVASalesOrderTypeUpdate., must be smaller than or equal to 3.');
        }
    ...
    public function setCustomerTaxClassification1($customer_tax_classification1)
    {
        ...
        if (!is_null($customer_tax_classification1) && (mb_strlen($customer_tax_classification1) > 1)) {
            throw new \InvalidArgumentException('invalid length for $customer_tax_classification1 when calling APISALESORDERSRVASalesOrderTypeUpdate., must be smaller than or equal to 1.');
        }
    ...
    public function setCustomerTaxClassification2($customer_tax_classification2)
    {
        ...
        if (!is_null($customer_tax_classification2) && (mb_strlen($customer_tax_classification2) > 1)) {
            throw new \InvalidArgumentException('invalid length for $customer_tax_classification2 when calling APISALESORDERSRVASalesOrderTypeUpdate., must be smaller than or equal to 1.');
        }
    ...
    public function setCustomerTaxClassification3($customer_tax_classification3)
    {
        ...
        if (!is_null($customer_tax_classification3) && (mb_strlen($customer_tax_classification3) > 1)) {
            throw new \InvalidArgumentException('invalid length for $customer_tax_classification3 when calling APISALESORDERSRVASalesOrderTypeUpdate., must be smaller than or equal to 1.');
        }
    ...
    public function setCustomerTaxClassification4($customer_tax_classification4)
    {
        ...
        if (!is_null($customer_tax_classification4) && (mb_strlen($customer_tax_classification4) > 1)) {
            throw new \InvalidArgumentException('invalid length for $customer_tax_classification4 when calling APISALESORDERSRVASalesOrderTypeUpdate., must be smaller than or equal to 1.');
        }
    ...
    public function setCustomerTaxClassification5($customer_tax_classification5)
    {
        ...
        if (!is_null($customer_tax_classification5) && (mb_strlen($customer_tax_classification5) > 1)) {
            throw new \InvalidArgumentException('invalid length for $customer_tax_classification5 when calling APISALESORDERSRVASalesOrderTypeUpdate., must be smaller than or equal to 1.');
        }
    ...
    public function setCustomerTaxClassification6($customer_tax_classification6)
    {
        ...
        if (!is_null($customer_tax_classification6) && (mb_strlen($customer_tax_classification6) > 1)) {
            throw new \InvalidArgumentException('invalid length for $customer_tax_classification6 when calling APISALESORDERSRVASalesOrderTypeUpdate., must be smaller than or equal to 1.');
        }
    ...
    public function setCustomerTaxClassification7($customer_tax_classification7)
    {
        ...
        if (!is_null($customer_tax_classification7) && (mb_strlen($customer_tax_classification7) > 1)) {
            throw new \InvalidArgumentException('invalid length for $customer_tax_classification7 when calling APISALESORDERSRVASalesOrderTypeUpdate., must be smaller than or equal to 1.');
        }
    ...
    public function setCustomerTaxClassification8($customer_tax_classification8)
    {
        ...
        if (!is_null($customer_tax_classification8) && (mb_strlen($customer_tax_classification8) > 1)) {
            throw new \InvalidArgumentException('invalid length for $customer_tax_classification8 when calling APISALESORDERSRVASalesOrderTypeUpdate., must be smaller than or equal to 1.');
        }
    ...
    public function setCustomerTaxClassification9($customer_tax_classification9)
    {
        ...
        if (!is_null($customer_tax_classification9) && (mb_strlen($customer_tax_classification9) > 1)) {
            throw new \InvalidArgumentException('invalid length for $customer_tax_classification9 when calling APISALESORDERSRVASalesOrderTypeUpdate., must be smaller than or equal to 1.');
        }
    ...
    public function setTaxDepartureCountry($tax_departure_country)
    {
        ...
        if (!is_null($tax_departure_country) && (mb_strlen($tax_departure_country) > 3)) {
            throw new \InvalidArgumentException('invalid length for $tax_departure_country when calling APISALESORDERSRVASalesOrderTypeUpdate., must be smaller than or equal to 3.');
        }
    ...
    public function setVatRegistrationCountry($vat_registration_country)
    {
        ...
        if (!is_null($vat_registration_country) && (mb_strlen($vat_registration_country) > 3)) {
            throw new \InvalidArgumentException('invalid length for $vat_registration_country when calling APISALESORDERSRVASalesOrderTypeUpdate., must be smaller than or equal to 3.');
        }
    ...
    public function setContractAccount($contract_account)
    {
        ...
        if (!is_null($contract_account) && (mb_strlen($contract_account) > 12)) {
            throw new \InvalidArgumentException('invalid length for $contract_account when calling APISALESORDERSRVASalesOrderTypeUpdate., must be smaller than or equal to 12.');
        }
    ...
    public function setAdditionalValueDays($additional_value_days)
    {
        ...
        if (!is_null($additional_value_days) && (mb_strlen($additional_value_days) > 2)) {
            throw new \InvalidArgumentException('invalid length for $additional_value_days when calling APISALESORDERSRVASalesOrderTypeUpdate., must be smaller than or equal to 2.');
        }
    ...
    public function setCustomerPurchaseOrderSuplmnt($customer_purchase_order_suplmnt)
    {
        ...
        if (!is_null($customer_purchase_order_suplmnt) && (mb_strlen($customer_purchase_order_suplmnt) > 4)) {
            throw new \InvalidArgumentException('invalid length for $customer_purchase_order_suplmnt when calling APISALESORDERSRVASalesOrderTypeUpdate., must be smaller than or equal to 4.');
        }
