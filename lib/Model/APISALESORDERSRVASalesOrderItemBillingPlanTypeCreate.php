...
/**
 * APISALESORDERSRVASalesOrderItemBillingPlanTypeCreate Class Doc Comment
 *
 * @category Class
 * @package  BeLenka\SAP\SalesOrder
 * @author   OpenAPI Generator team
 ...
 */
class APISALESORDERSRVASalesOrderItemBillingPlanTypeCreate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'API_SALES_ORDER_SRV.A_SalesOrderItemBillingPlanType-create';
    ...
    protected static $openAPITypes = [
        ...
        'to_billing_plan_item' => '\BeLenka\SAP\SalesOrder\Model\APISALESORDERSRVASalesOrderItemBillingPlanTypeCreateToBillingPlanItem',
    ...
    */
    ...
    public function setBillingPlanStartDateRule($billing_plan_start_date_rule)
    {
        ...
        if (!is_null($billing_plan_start_date_rule) && (mb_strlen($billing_plan_start_date_rule) > 2)) {
            throw new \InvalidArgumentException('invalid length for $billing_plan_start_date_rule when calling APISALESORDERSRVASalesOrderItemBillingPlanTypeCreate., must be smaller than or equal to 2.');
        }
    ...
    public function setReferenceBillingPlan($reference_billing_plan)
    {
        ...
        if (!is_null($reference_billing_plan) && (mb_strlen($reference_billing_plan) > 10)) {
            throw new \InvalidArgumentException('invalid length for $reference_billing_plan when calling APISALESORDERSRVASalesOrderItemBillingPlanTypeCreate., must be smaller than or equal to 10.');
        }
     ...
     *
     * @return \BeLenka\SAP\SalesOrder\Model\APISALESORDERSRVASalesOrderItemBillingPlanTypeCreateToBillingPlanItem|null
     */
     ...
     *
     * @param \BeLenka\SAP\SalesOrder\Model\APISALESORDERSRVASalesOrderItemBillingPlanTypeCreateToBillingPlanItem|null $to_billing_plan_item to_billing_plan_item
     *
     * @return self
     */
