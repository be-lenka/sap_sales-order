...
/**
 * APISALESORDERSRVASalesOrderItemPartnerTypeUpdate Class Doc Comment
 *
 * @category Class
 * @package  BeLenka\SAP\SalesOrder
 * @author   OpenAPI Generator team
 ...
 */
class APISALESORDERSRVASalesOrderItemPartnerTypeUpdate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'API_SALES_ORDER_SRV.A_SalesOrderItemPartnerType-update';
    ...
    */
    ...
    public function setCustomer($customer)
    {
        ...
        if (!is_null($customer) && (mb_strlen($customer) > 10)) {
            throw new \InvalidArgumentException('invalid length for $customer when calling APISALESORDERSRVASalesOrderItemPartnerTypeUpdate., must be smaller than or equal to 10.');
        }
    ...
    public function setSupplier($supplier)
    {
        ...
        if (!is_null($supplier) && (mb_strlen($supplier) > 10)) {
            throw new \InvalidArgumentException('invalid length for $supplier when calling APISALESORDERSRVASalesOrderItemPartnerTypeUpdate., must be smaller than or equal to 10.');
        }
    ...
    public function setPersonnel($personnel)
    {
        ...
        if (!is_null($personnel) && (mb_strlen($personnel) > 8)) {
            throw new \InvalidArgumentException('invalid length for $personnel when calling APISALESORDERSRVASalesOrderItemPartnerTypeUpdate., must be smaller than or equal to 8.');
        }
    ...
    public function setContactPerson($contact_person)
    {
        ...
        if (!is_null($contact_person) && (mb_strlen($contact_person) > 10)) {
            throw new \InvalidArgumentException('invalid length for $contact_person when calling APISALESORDERSRVASalesOrderItemPartnerTypeUpdate., must be smaller than or equal to 10.');
        }
    ...
    public function setAddressId($address_id)
    {
        ...
        if (!is_null($address_id) && (mb_strlen($address_id) > 10)) {
            throw new \InvalidArgumentException('invalid length for $address_id when calling APISALESORDERSRVASalesOrderItemPartnerTypeUpdate., must be smaller than or equal to 10.');
        }
    ...
    public function setVatRegistration($vat_registration)
    {
        ...
        if (!is_null($vat_registration) && (mb_strlen($vat_registration) > 20)) {
            throw new \InvalidArgumentException('invalid length for $vat_registration when calling APISALESORDERSRVASalesOrderItemPartnerTypeUpdate., must be smaller than or equal to 20.');
        }
