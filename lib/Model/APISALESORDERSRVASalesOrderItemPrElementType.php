...
/**
 * APISALESORDERSRVASalesOrderItemPrElementType Class Doc Comment
 *
 * @category Class
 * @package  BeLenka\SAP\SalesOrder
 * @author   OpenAPI Generator team
 ...
 */
class APISALESORDERSRVASalesOrderItemPrElementType implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'API_SALES_ORDER_SRV.A_SalesOrderItemPrElementType';
    ...
    */
    ...
    public function setSalesOrder($sales_order)
    {
        ...
        if ((mb_strlen($sales_order) > 10)) {
            throw new \InvalidArgumentException('invalid length for $sales_order when calling APISALESORDERSRVASalesOrderItemPrElementType., must be smaller than or equal to 10.');
        }
    ...
    public function setSalesOrderItem($sales_order_item)
    {
        ...
        if ((mb_strlen($sales_order_item) > 6)) {
            throw new \InvalidArgumentException('invalid length for $sales_order_item when calling APISALESORDERSRVASalesOrderItemPrElementType., must be smaller than or equal to 6.');
        }
    ...
    public function setPricingProcedureStep($pricing_procedure_step)
    {
        ...
        if ((mb_strlen($pricing_procedure_step) > 3)) {
            throw new \InvalidArgumentException('invalid length for $pricing_procedure_step when calling APISALESORDERSRVASalesOrderItemPrElementType., must be smaller than or equal to 3.');
        }
    ...
    public function setPricingProcedureCounter($pricing_procedure_counter)
    {
        ...
        if ((mb_strlen($pricing_procedure_counter) > 3)) {
            throw new \InvalidArgumentException('invalid length for $pricing_procedure_counter when calling APISALESORDERSRVASalesOrderItemPrElementType., must be smaller than or equal to 3.');
        }
    ...
    public function setConditionType($condition_type)
    {
        ...
        if (!is_null($condition_type) && (mb_strlen($condition_type) > 4)) {
            throw new \InvalidArgumentException('invalid length for $condition_type when calling APISALESORDERSRVASalesOrderItemPrElementType., must be smaller than or equal to 4.');
        }
    ...
    public function setPricingDateTime($pricing_date_time)
    {
        ...
        if (!is_null($pricing_date_time) && (mb_strlen($pricing_date_time) > 14)) {
            throw new \InvalidArgumentException('invalid length for $pricing_date_time when calling APISALESORDERSRVASalesOrderItemPrElementType., must be smaller than or equal to 14.');
        }
    ...
    public function setConditionCalculationType($condition_calculation_type)
    {
        ...
        if (!is_null($condition_calculation_type) && (mb_strlen($condition_calculation_type) > 3)) {
            throw new \InvalidArgumentException('invalid length for $condition_calculation_type when calling APISALESORDERSRVASalesOrderItemPrElementType., must be smaller than or equal to 3.');
        }
    ...
    public function setConditionCurrency($condition_currency)
    {
        ...
        if (!is_null($condition_currency) && (mb_strlen($condition_currency) > 5)) {
            throw new \InvalidArgumentException('invalid length for $condition_currency when calling APISALESORDERSRVASalesOrderItemPrElementType., must be smaller than or equal to 5.');
        }
    ...
    public function setConditionQuantityUnit($condition_quantity_unit)
    {
        ...
        if (!is_null($condition_quantity_unit) && (mb_strlen($condition_quantity_unit) > 3)) {
            throw new \InvalidArgumentException('invalid length for $condition_quantity_unit when calling APISALESORDERSRVASalesOrderItemPrElementType., must be smaller than or equal to 3.');
        }
    ...
    public function setConditionQuantitySapUnit($condition_quantity_sap_unit)
    {
        ...
        if (!is_null($condition_quantity_sap_unit) && (mb_strlen($condition_quantity_sap_unit) > 3)) {
            throw new \InvalidArgumentException('invalid length for $condition_quantity_sap_unit when calling APISALESORDERSRVASalesOrderItemPrElementType., must be smaller than or equal to 3.');
        }
    ...
    public function setConditionQuantityIsoUnit($condition_quantity_iso_unit)
    {
        ...
        if (!is_null($condition_quantity_iso_unit) && (mb_strlen($condition_quantity_iso_unit) > 3)) {
            throw new \InvalidArgumentException('invalid length for $condition_quantity_iso_unit when calling APISALESORDERSRVASalesOrderItemPrElementType., must be smaller than or equal to 3.');
        }
    ...
    public function setConditionCategory($condition_category)
    {
        ...
        if (!is_null($condition_category) && (mb_strlen($condition_category) > 1)) {
            throw new \InvalidArgumentException('invalid length for $condition_category when calling APISALESORDERSRVASalesOrderItemPrElementType., must be smaller than or equal to 1.');
        }
    ...
    public function setPricingScaleType($pricing_scale_type)
    {
        ...
        if (!is_null($pricing_scale_type) && (mb_strlen($pricing_scale_type) > 1)) {
            throw new \InvalidArgumentException('invalid length for $pricing_scale_type when calling APISALESORDERSRVASalesOrderItemPrElementType., must be smaller than or equal to 1.');
        }
    ...
    public function setCndnIsRelevantForInvoiceList($cndn_is_relevant_for_invoice_list)
    {
        ...
        if (!is_null($cndn_is_relevant_for_invoice_list) && (mb_strlen($cndn_is_relevant_for_invoice_list) > 1)) {
            throw new \InvalidArgumentException('invalid length for $cndn_is_relevant_for_invoice_list when calling APISALESORDERSRVASalesOrderItemPrElementType., must be smaller than or equal to 1.');
        }
    ...
    public function setConditionOrigin($condition_origin)
    {
        ...
        if (!is_null($condition_origin) && (mb_strlen($condition_origin) > 1)) {
            throw new \InvalidArgumentException('invalid length for $condition_origin when calling APISALESORDERSRVASalesOrderItemPrElementType., must be smaller than or equal to 1.');
        }
    ...
    public function setIsGroupCondition($is_group_condition)
    {
        ...
        if (!is_null($is_group_condition) && (mb_strlen($is_group_condition) > 1)) {
            throw new \InvalidArgumentException('invalid length for $is_group_condition when calling APISALESORDERSRVASalesOrderItemPrElementType., must be smaller than or equal to 1.');
        }
    ...
    public function setConditionRecord($condition_record)
    {
        ...
        if (!is_null($condition_record) && (mb_strlen($condition_record) > 10)) {
            throw new \InvalidArgumentException('invalid length for $condition_record when calling APISALESORDERSRVASalesOrderItemPrElementType., must be smaller than or equal to 10.');
        }
    ...
    public function setConditionSequentialNumber($condition_sequential_number)
    {
        ...
        if (!is_null($condition_sequential_number) && (mb_strlen($condition_sequential_number) > 3)) {
            throw new \InvalidArgumentException('invalid length for $condition_sequential_number when calling APISALESORDERSRVASalesOrderItemPrElementType., must be smaller than or equal to 3.');
        }
    ...
    public function setTaxCode($tax_code)
    {
        ...
        if (!is_null($tax_code) && (mb_strlen($tax_code) > 2)) {
            throw new \InvalidArgumentException('invalid length for $tax_code when calling APISALESORDERSRVASalesOrderItemPrElementType., must be smaller than or equal to 2.');
        }
    ...
    public function setWithholdingTaxCode($withholding_tax_code)
    {
        ...
        if (!is_null($withholding_tax_code) && (mb_strlen($withholding_tax_code) > 2)) {
            throw new \InvalidArgumentException('invalid length for $withholding_tax_code when calling APISALESORDERSRVASalesOrderItemPrElementType., must be smaller than or equal to 2.');
        }
    ...
    public function setTransactionCurrency($transaction_currency)
    {
        ...
        if (!is_null($transaction_currency) && (mb_strlen($transaction_currency) > 5)) {
            throw new \InvalidArgumentException('invalid length for $transaction_currency when calling APISALESORDERSRVASalesOrderItemPrElementType., must be smaller than or equal to 5.');
        }
    ...
    public function setConditionControl($condition_control)
    {
        ...
        if (!is_null($condition_control) && (mb_strlen($condition_control) > 1)) {
            throw new \InvalidArgumentException('invalid length for $condition_control when calling APISALESORDERSRVASalesOrderItemPrElementType., must be smaller than or equal to 1.');
        }
    ...
    public function setConditionInactiveReason($condition_inactive_reason)
    {
        ...
        if (!is_null($condition_inactive_reason) && (mb_strlen($condition_inactive_reason) > 1)) {
            throw new \InvalidArgumentException('invalid length for $condition_inactive_reason when calling APISALESORDERSRVASalesOrderItemPrElementType., must be smaller than or equal to 1.');
        }
    ...
    public function setConditionClass($condition_class)
    {
        ...
        if (!is_null($condition_class) && (mb_strlen($condition_class) > 1)) {
            throw new \InvalidArgumentException('invalid length for $condition_class when calling APISALESORDERSRVASalesOrderItemPrElementType., must be smaller than or equal to 1.');
        }
    ...
    public function setPrcgProcedureCounterForHeader($prcg_procedure_counter_for_header)
    {
        ...
        if (!is_null($prcg_procedure_counter_for_header) && (mb_strlen($prcg_procedure_counter_for_header) > 3)) {
            throw new \InvalidArgumentException('invalid length for $prcg_procedure_counter_for_header when calling APISALESORDERSRVASalesOrderItemPrElementType., must be smaller than or equal to 3.');
        }
    ...
    public function setStructureCondition($structure_condition)
    {
        ...
        if (!is_null($structure_condition) && (mb_strlen($structure_condition) > 1)) {
            throw new \InvalidArgumentException('invalid length for $structure_condition when calling APISALESORDERSRVASalesOrderItemPrElementType., must be smaller than or equal to 1.');
        }
    ...
    public function setPricingScaleBasis($pricing_scale_basis)
    {
        ...
        if (!is_null($pricing_scale_basis) && (mb_strlen($pricing_scale_basis) > 3)) {
            throw new \InvalidArgumentException('invalid length for $pricing_scale_basis when calling APISALESORDERSRVASalesOrderItemPrElementType., must be smaller than or equal to 3.');
        }
    ...
    public function setConditionScaleBasisUnit($condition_scale_basis_unit)
    {
        ...
        if (!is_null($condition_scale_basis_unit) && (mb_strlen($condition_scale_basis_unit) > 3)) {
            throw new \InvalidArgumentException('invalid length for $condition_scale_basis_unit when calling APISALESORDERSRVASalesOrderItemPrElementType., must be smaller than or equal to 3.');
        }
    ...
    public function setConditionScaleBasisCurrency($condition_scale_basis_currency)
    {
        ...
        if (!is_null($condition_scale_basis_currency) && (mb_strlen($condition_scale_basis_currency) > 5)) {
            throw new \InvalidArgumentException('invalid length for $condition_scale_basis_currency when calling APISALESORDERSRVASalesOrderItemPrElementType., must be smaller than or equal to 5.');
        }
    ...
    public function setVariantCondition($variant_condition)
    {
        ...
        if (!is_null($variant_condition) && (mb_strlen($variant_condition) > 26)) {
            throw new \InvalidArgumentException('invalid length for $variant_condition when calling APISALESORDERSRVASalesOrderItemPrElementType., must be smaller than or equal to 26.');
        }
