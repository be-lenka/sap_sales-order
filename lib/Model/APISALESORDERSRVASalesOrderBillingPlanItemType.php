...
/**
 * APISALESORDERSRVASalesOrderBillingPlanItemType Class Doc Comment
 *
 * @category Class
 * @package  BeLenka\SAP\SalesOrder
 * @author   OpenAPI Generator team
 ...
 */
class APISALESORDERSRVASalesOrderBillingPlanItemType implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'API_SALES_ORDER_SRV.A_SalesOrderBillingPlanItemType';
    ...
    */
    ...
    public function setSalesOrder($sales_order)
    {
        ...
        if ((mb_strlen($sales_order) > 10)) {
            throw new \InvalidArgumentException('invalid length for $sales_order when calling APISALESORDERSRVASalesOrderBillingPlanItemType., must be smaller than or equal to 10.');
        }
    ...
    public function setBillingPlan($billing_plan)
    {
        ...
        if ((mb_strlen($billing_plan) > 10)) {
            throw new \InvalidArgumentException('invalid length for $billing_plan when calling APISALESORDERSRVASalesOrderBillingPlanItemType., must be smaller than or equal to 10.');
        }
    ...
    public function setBillingPlanItem($billing_plan_item)
    {
        ...
        if ((mb_strlen($billing_plan_item) > 6)) {
            throw new \InvalidArgumentException('invalid length for $billing_plan_item when calling APISALESORDERSRVASalesOrderBillingPlanItemType., must be smaller than or equal to 6.');
        }
    ...
    public function setBillingPlanDateCategory($billing_plan_date_category)
    {
        ...
        if (!is_null($billing_plan_date_category) && (mb_strlen($billing_plan_date_category) > 2)) {
            throw new \InvalidArgumentException('invalid length for $billing_plan_date_category when calling APISALESORDERSRVASalesOrderBillingPlanItemType., must be smaller than or equal to 2.');
        }
    ...
    public function setTransactionCurrency($transaction_currency)
    {
        ...
        if (!is_null($transaction_currency) && (mb_strlen($transaction_currency) > 5)) {
            throw new \InvalidArgumentException('invalid length for $transaction_currency when calling APISALESORDERSRVASalesOrderBillingPlanItemType., must be smaller than or equal to 5.');
        }
    ...
    public function setCustomerPaymentTerms($customer_payment_terms)
    {
        ...
        if (!is_null($customer_payment_terms) && (mb_strlen($customer_payment_terms) > 4)) {
            throw new \InvalidArgumentException('invalid length for $customer_payment_terms when calling APISALESORDERSRVASalesOrderBillingPlanItemType., must be smaller than or equal to 4.');
        }
    ...
    public function setProposedBillingDocumentType($proposed_billing_document_type)
    {
        ...
        if (!is_null($proposed_billing_document_type) && (mb_strlen($proposed_billing_document_type) > 4)) {
            throw new \InvalidArgumentException('invalid length for $proposed_billing_document_type when calling APISALESORDERSRVASalesOrderBillingPlanItemType., must be smaller than or equal to 4.');
        }
    ...
    public function setBillingPlanDateDescriptionCode($billing_plan_date_description_code)
    {
        ...
        if (!is_null($billing_plan_date_description_code) && (mb_strlen($billing_plan_date_description_code) > 4)) {
            throw new \InvalidArgumentException('invalid length for $billing_plan_date_description_code when calling APISALESORDERSRVASalesOrderBillingPlanItemType., must be smaller than or equal to 4.');
        }
    ...
    public function setBillingBlockReason($billing_block_reason)
    {
        ...
        if (!is_null($billing_block_reason) && (mb_strlen($billing_block_reason) > 2)) {
            throw new \InvalidArgumentException('invalid length for $billing_block_reason when calling APISALESORDERSRVASalesOrderBillingPlanItemType., must be smaller than or equal to 2.');
        }
    ...
    public function setBillingPlanRelatedBillgStatus($billing_plan_related_billg_status)
    {
        ...
        if (!is_null($billing_plan_related_billg_status) && (mb_strlen($billing_plan_related_billg_status) > 1)) {
            throw new \InvalidArgumentException('invalid length for $billing_plan_related_billg_status when calling APISALESORDERSRVASalesOrderBillingPlanItemType., must be smaller than or equal to 1.');
        }
    ...
    public function setBillingPlanType($billing_plan_type)
    {
        ...
        if (!is_null($billing_plan_type) && (mb_strlen($billing_plan_type) > 2)) {
            throw new \InvalidArgumentException('invalid length for $billing_plan_type when calling APISALESORDERSRVASalesOrderBillingPlanItemType., must be smaller than or equal to 2.');
        }
    ...
    public function setAdoptingBillingDateId($adopting_billing_date_id)
    {
        ...
        if (!is_null($adopting_billing_date_id) && (mb_strlen($adopting_billing_date_id) > 1)) {
            throw new \InvalidArgumentException('invalid length for $adopting_billing_date_id when calling APISALESORDERSRVASalesOrderBillingPlanItemType., must be smaller than or equal to 1.');
        }
    ...
    public function setBillingPlanBillingRule($billing_plan_billing_rule)
    {
        ...
        if (!is_null($billing_plan_billing_rule) && (mb_strlen($billing_plan_billing_rule) > 1)) {
            throw new \InvalidArgumentException('invalid length for $billing_plan_billing_rule when calling APISALESORDERSRVASalesOrderBillingPlanItemType., must be smaller than or equal to 1.');
        }
    ...
    public function setBillingPlanMilestoneUsage($billing_plan_milestone_usage)
    {
        ...
        if (!is_null($billing_plan_milestone_usage) && (mb_strlen($billing_plan_milestone_usage) > 5)) {
            throw new \InvalidArgumentException('invalid length for $billing_plan_milestone_usage when calling APISALESORDERSRVASalesOrderBillingPlanItemType., must be smaller than or equal to 5.');
        }
    ...
    public function setBillgPlnDteCorrectionRfndType($billg_pln_dte_correction_rfnd_type)
    {
        ...
        if (!is_null($billg_pln_dte_correction_rfnd_type) && (mb_strlen($billg_pln_dte_correction_rfnd_type) > 1)) {
            throw new \InvalidArgumentException('invalid length for $billg_pln_dte_correction_rfnd_type when calling APISALESORDERSRVASalesOrderBillingPlanItemType., must be smaller than or equal to 1.');
        }
    ...
    public function setPostponementReason($postponement_reason)
    {
        ...
        if (!is_null($postponement_reason) && (mb_strlen($postponement_reason) > 255)) {
            throw new \InvalidArgumentException('invalid length for $postponement_reason when calling APISALESORDERSRVASalesOrderBillingPlanItemType., must be smaller than or equal to 255.');
        }
